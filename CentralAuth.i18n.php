...
If the global account is yours too, you can merge this account if you type the global account password:',
	...
	'centralauth-admin-markasmigrating-title'         => 'Mark account as migrating',
	'centralauth-admin-markasmigrating-description'   => 'If account is in migration state, local bureaucrats may rename other accounts to its name.',
	'centralauth-admin-markasmigrating-button'        => 'Mark account as migrating',
	'centralauth-admin-markasmigrating-success'       => 'Successfully marked the global account for "<nowiki>$1</nowiki>" as migrating',
	'centralauth-admin-markasmigrating-nonexistent'   => 'Error: the global account "<nowiki>$1</nowiki>" does not exist.',
	'centralauth-admin-unmarkasmigrating-title'       => 'Unmark this account as migrating',
	'centralauth-admin-unmarkasmigrating-description' => 'Allows to remove migration mark from the account.',
	'centralauth-admin-unmarkasmigrating-button'      => 'Umark this account as migrating',
	'centralauth-admin-unmarkasmigrating-success'     => 'Successfully unmarked the global account for "<nowiki>$1</nowiki>" as migrating',
	'centralauth-admin-unmarkasmigrating-nonexistent' => 'Error: the global account "<nowiki>$1</nowiki>" does not exist.',
...
لو كان هذا أنت، يمكنك إنهاء عملية توحيد الدخول ببساطة بكتابة كلمة السر الرئيسية لذلك الحساب هنا:',
	'centralauth-blocked-text'                        => 'الويكي الرئيسي الخاص بك (معروض بالأسفل) ممنوع من التعديل. من فضلك اتصل بمدير نظام في هذا الويكي لرفع المنع عنه. بينما هو ممنوع، لا يمكنك دمج حساباتك.',
	...
	'centralauth-admin-hide-title'                    => 'إخفاء الحساب',
	'centralauth-admin-hide-description'              => 'الحسابات المخفية لا تعرض في [[Special:GlobalUsers|المستخدمين العامين]].',
	'centralauth-admin-hide-button'                   => 'أخف هذا الحساب',
	'centralauth-admin-hide-success'                  => 'بنجاح أخفى الحساب العام ل"<nowiki>$1</nowiki>"',
	'centralauth-admin-hide-nonexistent'              => 'خطأ: الحساب العام "<nowiki>$1</nowiki>" غير موجود.',
	'centralauth-admin-unhide-title'                  => 'إظهار الحساب',
	'centralauth-admin-unhide-description'            => 'إظهار الحساب سيجعله يظهر مرة أخرى في [[Special:GlobalUsers|المستخدمين العامين]].',
	'centralauth-admin-unhide-button'                 => 'أظهر هذا الحساب',
	'centralauth-admin-unhide-success'                => 'بنجاح أظهر الحساب العام ل"<nowiki>$1</nowiki>"',
	'centralauth-admin-unhide-nonexistent'            => 'خطأ: الحساب العام "<nowiki>$1</nowiki>" غير موجود.',
	'centralauth-admin-markasmigrating-title'         => 'علم على الحساب كمهاجر',
	'centralauth-admin-markasmigrating-description'   => 'لو أن الحساب في حالة هجرة، البيروقراطيون المحليون يمكنهم إعادة تسمية الحسابات الأخرى لاسمه.',
	'centralauth-admin-markasmigrating-button'        => 'التعليم على الحساب كمهاجر',
	'centralauth-admin-markasmigrating-success'       => 'بنجاح علم على الحساب العام ل "<nowiki>$1</nowiki>" كمهاجر',
	'centralauth-admin-markasmigrating-nonexistent'   => 'خطأ: الحساب العام "<nowiki>$1</nowiki>" غير موجود.',
	'centralauth-admin-unmarkasmigrating-title'       => 'إزالة تعليم هذا الحساب كمهاجر',
	'centralauth-admin-unmarkasmigrating-description' => 'يسمح بإزالة علامة الهجرة من الحساب.',
	'centralauth-admin-unmarkasmigrating-button'      => 'إزالة تعليم هذا الحساب كمراجع',
	'centralauth-admin-unmarkasmigrating-success'     => 'بنجاح أزال تعليم الحساب العام ل "<nowiki>$1</nowiki>" كمهاجر',
	'centralauth-admin-unmarkasmigrating-nonexistent' => 'خطأ: الحساب العام "<nowiki>$1</nowiki>" غير موجود.',
...
عندما [[Special:UserLogin|تسجل الدخول]]، نظام الدخول المركزي يأمر متصفحك أن يطلب هذه الصفحة من كل النطق الموصولة، باستخدام وصلات صورة.
لقد طلبت هذه الصفحة بدون توفير بيانات هوية، لذا فهي لا تفعل أي شيء.',
	'centralauth-login-progress'                      => 'تسجيل دخولك إلى مشاريع ويكيميديا الأخرى:',
	'centralauth-logout-progress'                     => 'تسجيل خروجك من مشاريع ويكيميديا الأخرى:',
	...
	'centralauth-log-entry-markasmigrating'           => 'علم على الحساب العام "<nowiki>$1</nowiki>" كمهاجر',
	'centralauth-log-entry-unmarkasmigrating'         => 'أزال تعليم الحساب العام "<nowiki>$1</nowiki>" كمهاجر',
...
$messages['bg'] = array(
	...
	'centralauth-merge-welcome'                       => "'''Вашата потребителска сметка все още не е преминала към новата система на Уикимедия за единна потребителска сметка.'''

Ако решите да обедините едноименните си сметки, ще можете да използвате едно и също потребителско име и парола, за да влизате във всички проекти на Уикимедия на всички достъпни езици.
Това улеснява работата в общи многоезични проекти, като например качването в [http://commons.wikimedia.org/ Общомедия], и избягва недоразуменията и конфликтите, които могат да произтекат от използването на едно и също потребителско име от различни хора в различните проекти.
...
Все още не са извършени промени във вашите сметки.',
	'centralauth-merge-dryrun-incomplete'             => 'Имате възможност да продължите, но някои сметки не можаха да бъдат автоматично потвърдени и не могат веднага да бъдат прикачени към общата.
По-нататък ще имате възможност да ги слеете.

Все още не са направени никакви промени по сметките ви.',
	'centralauth-merge-dryrun-or'                     => "'''или'''",
	'centralauth-merge-dryrun-home'                   => 'Системата за обединение на сметките не можа да потвърди, че вие сте притежателят на сметката в домашното уики за вашето потребителско име.

Друго уики е било посочено като домашно за вашето потребителско име; последвайте връзката по-долу и влезте в това уики, откъдето да завършите процедурата по обединението на сметките си.',
	...
	'centralauth-complete'                            => 'Обединяването на сметките завърши!',
...
'''Внимание!''' Преди да пристъпите към сливане на сметките, [http://toolserver.org/~vvv/sulutil.php проверете за конфликти] с други потребители, които са използвали същото потребителско име като вашето за регистрацията си в други проекти.",
...
Ако това сте вие, можете да завършите процедурата по обединение на сметки, като просто въведете главната парола за тази сметка тук:',
	...
	'centralauth-list-home-dryrun'                    => 'Паролата и електронната поща за настоящото уики ще бъдат използвани за глобалната ви сметка. По-нататък ще имате възможност да смените домашното си уики.',
	'centralauth-list-attached-title'                 => 'Прикрепени сметки',
	'centralauth-list-attached'                       => 'Потребителската сметка „$1“ на всеки от следните сайтове беше автоматично прикачена към глобалната сметка:',
	'centralauth-list-attached-dryrun'                => 'Потребителската сметка „$1“ на всеки от следните сайтове ще бъде автоматично прикачена към глобалната сметка:',
...
най-вероятно има различна парола от основната сметка:',
	...
	'centralauth-merge-method-primary'                => 'домашно уики',
...
Другите сметки все още не са потвърдени.',
	...
	'centralauth-admin-info-locked'                   => 'Заключена:',
	'centralauth-admin-info-hidden'                   => 'Скрита:',
	'centralauth-admin-yes'                           => 'да',
	'centralauth-admin-no'                            => 'не',
	'centralauth-admin-attached'                      => 'Изцяло слети сметки',
	'centralauth-admin-unattached'                    => 'Неприкачени сметки',
	'centralauth-admin-no-unattached'                 => 'Не са останали неслети сметки.',
	'centralauth-admin-list-localwiki'                => 'Локално уики',
	'centralauth-admin-list-attached-on'              => 'Прикачена към',
	...
	'centralauth-admin-hide-title'                    => 'Скриване на сметка',
	'centralauth-admin-hide-description'              => 'Скритите сметки не се показват на страницата [[Special:GlobalUsers|Глобални потребители]].',
	'centralauth-admin-hide-button'                   => 'Скриване на сметката',
	...
	'centralauth-listusers-nolocal'                   => 'неприкачена или не съществува локално',
...
Извикали сте настоящата страница, без да посочите удостоверяващи данни, затова нищо повече няма да се случи.',
	'centralauth-login-progress'                      => 'Влизате автоматично и в следните проекти на Уикимедия:',
	'centralauth-logout-progress'                     => 'Излизате автоматично и от следните проекти на Уикимедия:',
	...
	'centralauth-rightslog-name'                      => 'Дневник на глобалните права',
	'centralauth-rightslog-entry-usergroups'          => 'смени глобалната групова принадлежност на $1 от $2 на $3',
	...
	'centralauth-globalgrouppermissions-knownwiki'    => 'Изберете уики, в което те имат сметка:',
...
Si el compte global és vostre, podeu associar-hi aquest compte escrivint la contrasenya:',
	...
	'centralauth-admin-lock-description'              => "Bloquejar el compte farà impossible d'entrar-hi en cap wiki.",
	'centralauth-admin-lock-button'                   => 'Bloca aquest compte',
	'centralauth-admin-lock-success'                  => 'Bloquejat el compte global per "<nowiki>$1</nowiki>"',
	'centralauth-admin-lock-nonexistent'              => 'Error: no existeix el compte global «<nowiki>$1</nowiki>».',
	'centralauth-admin-unlock-title'                  => 'Desbloca el compte',
	'centralauth-admin-unlock-description'            => "Desbloquejar el compte permetrà d'entrar-hi una altra vegada.",
	'centralauth-admin-unlock-button'                 => 'Desbloqueja aquest compte',
	'centralauth-admin-unlock-success'                => 'Desbloquejat el compte global per "<nowiki>$1</nowiki>"',
...
Heu demanat aquesta pàgina sense haver proporcionat dades d'autentificació, així que no fa res.",
	...
	'centralauth-globalgroupperms-grouplistitem'      => '$1 ([[Special:GlobalGroupPermissions/$2|Vegeu i editeu autoritzacions]])',
...
Pokud se rozhodnete převést své účty, budete moci používat stejné uživatelské jméno a heslo k přihlášení do všech projektů nadace Wikimedia ve všech dostupných jazycích. To vám zjednoduší práci na sdílených projektech, například načítání souborů na [http://commons.wikimedia.org/ Wikimedia Commons], a předejde se konfliktům a zmatkům, které mohou vzniknout, pokud si dva lidé na různých projektech vyberou stejné uživatelské jméno.

Pokud si již někdo jiný vzal vaše uživatelské jméno na jiném projektu, tak to neovlivníte, ale budete mít možnost se později dohodnout na řešení, ať už přímo, nebo s pomocí správců.

'''Upozornění:''' Pokud na některém projektu používáte jiné uživatelské jméno a chcete sloučit i tento účet, musíte si přejmenování účtu zajistit ''ještě před převedením na jednotný systém''! V současné chvíli nelze přejmenovávat uživatele na jména již převedených globálních účtů!",
	'centralauth-merge-step1-title'                   => 'Začít sjednocovat přihlašování',
	'centralauth-merge-step1-detail'                  => 'Prosím, zadejte heslo k vašemu účtu.
Vaše heslo a registrovaná e-mailová adresa se porovnají s účty na ostatních wiki, aby se potvrdilo, že se shodují.
Žádné změny se neprovedou, dokud nepotrvrdíte, že je vše v pořádku.',
...
Pokud to jste vy, můžete dokončit proces sjednocení přihlašování zadáním hesla pro uvedený účet:',
	...
	'centralauth-finish-incomplete'                   => 'Použitím tohoto hesla bylo sloučeno několik účtů. Další účty zatím nejsou potvrzeny.',
	...
	'centralauth-admin-unlock-description'            => 'Odemknutím účtu opět umožníte přihlášení se k němu.',
	...
	'centralauth-login-progress'                      => 'Automatické přihlášení na další projekty Wikimedia:',
	'centralauth-logout-progress'                     => 'Automatické odhlášení z jiných projektů Wikimedia:',
	...
	'centralauth-newgroup-intro'                      => 'Tento formulář můžete použít pro přidělení oprávnění nové skupině. Pamatujte, že skupina neexistuje, dokud nemá přidělená oprávnění.',
...
$messages['cy'] = array(
	...
	'centralauth-admin-info-locked'          => 'Wedi cloi:',
	'centralauth-admin-info-hidden'          => 'Wedi cuddio:',
	...
	'centralauth-prefs-detail-unattached'    => "Ni chadarnhawyd bod y safle prosiect hwn yn aelod o'r cyfrif wici-gyfan.",
	'centralauth-prefs-manage'               => "Rheoli'ch cyfrif wici-gyfan",
	'centralauth-login-progress'             => 'Yn mewngofnodi i brosiectau eraill Wikimedia hefyd:',
	'centralauth-logout-progress'            => 'Yn allgofnodi o brosiectau eraill Wikimedia hefyd:',
	'centralauth-log-name'                   => 'Lòg cyfrifon wici-gyfan',
	'centralauth-log-entry-delete'           => 'wedi dileu cyfrif wici-gyfan "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-lock'             => 'wedi cloi cyfrif wici-gyfan "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-unlock'           => 'wedi datgloi cyfrif wici-gyfan "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-hide'             => 'wedi cuddio cyfrif wici-gyfan "<nowiki>$1</nowiki>"',
	'centralauth-rightslog-name'             => 'Lòg galluoedd wici-gyfan',
	'centralauth-rightslog-entry-usergroups' => 'newidiwyd aelodaeth grŵp wici-gyfan $1 o $2 i $3',
	'centralauth-rightslog-entry-groupperms' => 'newidiwyd galluoedd y grŵp $1 o $2 i $3',
);
...
Du kannst die 'E-Mail an Benutzer'-Funktion erst nutzen, wenn du eine gültige E-Mail-Adresse in deinen [[Special:Preferences|persönlichen Einstellungen]] eingegeben hast und die E-Mail-Funktion nicht gesperrt wurde.",
	...
	'centralauth-admin-hide-title'                    => 'Benutzerkonto verstecken',
	'centralauth-admin-hide-description'              => 'Versteckte Benutzerkonten werden nicht in der [[Special:GlobalUsers|Liste globaler Benutzerkonten]] gezeigt.',
	'centralauth-admin-hide-button'                   => 'Dieses Benutzerkonto verstecken',
	'centralauth-admin-hide-success'                  => 'Das globale Benutzerkonto „<nowiki>$1</nowiki>“ wurde erfolgreich versteckt.',
	'centralauth-admin-hide-nonexistent'              => 'Fehler: Das globale Benutzerkonto „<nowiki>$1</nowiki>“ ist nicht vorhanden.',
	'centralauth-admin-unhide-title'                  => 'Benutzerkonto wieder sichtbar machen',
	'centralauth-admin-unhide-description'            => 'Durch die Sichtbarmachung globalen Benutzerkontos erscheint es wieder in der [[Special:GlobalUsers|Liste globaler Benutzerkonten]].',
	...
	'centralauth-log-entry-hide'                      => 'versteckte das globale Benutzerkonto „<nowiki>$1</nowiki>“',
	'centralauth-log-entry-unhide'                    => 'machte das globale Benutzerkonto „<nowiki>$1</nowiki>“ wieder sichtbar',
...
Se la ĝenerala konto ankaŭ estas via, vi povas unuigi ĉi tiun konton se vi tajpas la pasvorton de la ĝenerala konto:',
	...
	'centralauth-admin-hide-title'                    => 'Kaŝi konton',
	'centralauth-admin-hide-description'              => 'Kaŝitaj kontoj ne estas montritaj en [[Special:GlobalUsers|Ĝeneralaj uzantoj]].',
	'centralauth-admin-hide-button'                   => 'Kaŝi ĉi tiun konton',
	'centralauth-admin-hide-success'                  => 'Sukcese kaŝis la ĝeneralan konton por "<nowiki>$1</nowiki>"',
	'centralauth-admin-hide-nonexistent'              => 'Eraro: la ĝenerala konto "<nowiki>$1</nowiki>" ne ekzistas.',
	'centralauth-admin-unhide-title'                  => 'Malkaŝi konton',
	'centralauth-admin-unhide-description'            => 'Malkaŝado do konto aperigos ĝin denove en [[Special:GlobalUsers|Ĝeneralaj uzantoj]].',
	'centralauth-admin-unhide-button'                 => 'Malkaŝi ĉi tiun konton',
	'centralauth-admin-unhide-success'                => 'Sukcese malkaŝis la ĝeneralan konton por "<nowiki>$1</nowiki>"',
	'centralauth-admin-unhide-nonexistent'            => 'Eraro: la ĝenerala konto "<nowiki>$1</nowiki>" ne ekzistas.',
	...
	'centralauth-rightslog-header'                    => 'Ĉi tiu protokolo enhavas funkciojn pri ĝeneralaj grupoj: membrecaj kaj rajtaj ŝanĝoj',
	...
	'centralauth-globalgroupperms-grouplistitem'      => '$1 ([[Special:GlobalGroupPermissions/$2|Rigardi kaj redakti rajtojn]])',
	'centralauth-existinggroup-legend'                => 'Ekzistantaj grupoj',
	'centralauth-newgroup-legend'                     => 'Krei novan grupon',
	'centralauth-newgroup-intro'                      => 'Vi povas uzi ĉi tiun paĝon por asigni rajtojn al nova grupo. Notu ke grupo ne ekzistas kvankam ĝi havas rajtojn asignitajn al ĝi.',
...
Podrás cambiar posteriormente la wiki considerada hogar.',
	...
	'right-centralauth-merge'             => 'Fusionar su propia cuenta',
...
Si c’est vous, vous pourrez terminer le processus d’unification de comptes en entrant ici le mot de passe principal pour ce compte :',
	...
	'centralauth-admin-hide-title'                    => 'Cacher le compte',
	'centralauth-admin-hide-description'              => 'Les comptes masqués ne sont pas affichés parmi [[Special:GlobalUsers|les utilisateurs globaux]].',
	'centralauth-admin-hide-button'                   => 'Cacher ce compte',
	'centralauth-admin-hide-success'                  => 'Le compte global pour « <nowiki>$1</nowiki> » a été caché avec succès.',
	'centralauth-admin-hide-nonexistent'              => 'Erreur : le compte global « <nowiki>$1</nowiki> » n’existe pas.',
	'centralauth-admin-unhide-title'                  => 'Faire réapparaître le compte',
	'centralauth-admin-unhide-description'            => 'La réapparition du compte le fera figurer parmi les [[Special:GlobalUsers|utilisateurs globaux]].',
	'centralauth-admin-unhide-button'                 => 'Faire réapparaître ce compte',
	'centralauth-admin-unhide-success'                => 'Réapparition du compte global « <nowiki>$1</nowiki> » réalisée avec succès',
	'centralauth-admin-unhide-nonexistent'            => 'Erreur : le compte global « <nowiki>$1</nowiki> » n’existe pas.',
	'centralauth-admin-markasmigrating-title'         => 'Marquer le compte comme étant en migration',
	'centralauth-admin-markasmigrating-description'   => 'Si un compte est en migration, les bureaucrates locaux peuvent renommer des autres compte vers son nom.',
	'centralauth-admin-markasmigrating-button'        => 'Marquer ce compte comme étant en migration',
	'centralauth-admin-markasmigrating-success'       => 'Le compte global « <nowiki>$1</nowiki> » a été marqué en migration avec succès',
	'centralauth-admin-markasmigrating-nonexistent'   => "Erreur : le compte global « <nowiki>$1</nowiki> » n'existe pas.",
	'centralauth-admin-unmarkasmigrating-nonexistent' => "Erreur : le compte global « <nowiki>$1</nowiki> » n'existe pas.",
...
Vous avez demandé cette page sans donner des informations d'authentification, elle ne fait donc rien.",
	'centralauth-login-progress'                      => 'Connexion aux autres projets Wikimedia :',
	'centralauth-logout-progress'                     => 'Déconnexion des autres projets Wikimedia :',
	...
	'centralauth-log-entry-hide'                      => 'a caché le compte global « <nowiki>$1</nowiki> »',
	'centralauth-log-entry-unhide'                    => 'a fait réapparaître le compte global « <nowiki>$1</nowiki> »',
	'centralauth-log-entry-markasmigrating'           => 'a marqué le compte global « <nowiki>$1</nowiki> » comme étant en migration',
...
Se alguén xa ten o seu nome de usuario noutro proxecto isto non o vai amolar, pero daralle unha posibilidade de traballar con el ou cun administrador máis adiante.",
	...
	'centralauth-merge-step1-detail'                  => 'Por favor, insira aquí o contrasinal da súa conta de usuario.
O seu contrasinal e os enderezos de correo electrónico rexistrados comprobaranse nas contas doutros wikis para confirmar que coinciden.
Non se realizarán cambios até que vostede confirme que todo está ben.',
...
Aínda non se produciu ninún cambio nas súas contas.',
	'centralauth-merge-dryrun-incomplete'             => 'Está listo para continuar, pero algunhas contas non puideron ser verificadas automaticamente e non serán unificadas inmediatamente.
Poderá fusionalas máis adiante.

Aínda non se produciu ningún cambio nas súas contas.',
	'centralauth-merge-dryrun-or'                     => "'''ou'''",
	'centralauth-merge-dryrun-home'                   => 'O sistema de migración non pode confirmar se vostede é o dono da conta do wiki primario do seu nome de usuario.

Outro wiki foi determinado como o wiki primario para outra conta co seu nome de usuario; siga a ligazón de embaixo e acceda ao sistema alí para finalizar coa súa migración de contas.',
	...
	'centralauth-merge-step3-submit'                  => 'Unificar as contas',
...
Se se trata de vostede, pode completar o proceso de unificación de rexistro simplemente con escribir o contrasinal mestre desa conta aquí:',
	'centralauth-blocked-text'                        => 'O seu wiki primario (escrito embaixo) está bloqueado fronte á edición. Por favor, contacte cun administrador dese wiki para que o desbloquee. Mentres estea bloqueado, non pode mesturar as súas contas.',
	...
	'centralauth-error-locked'                        => 'Non pode editar porque a súa conta está pechada.',
...
Outras contas aínda non están confirmadas.',
	...
	'centralauth-attach-submit'                       => 'Unificar a conta',
	...
	'centralauth-admin-already-unmerged'              => 'Saltando $1, xa non fusionadas',
	...
	'centralauth-admin-nonexistent'                   => 'Non hai ningunha conta global para "<nowiki>$1</nowiki>"',
	...
	'centralauth-admin-hide-title'                    => 'Agochar unha conta',
	'centralauth-admin-hide-description'              => 'As contas agochadas non se amosan en [[Special:GlobalUsers|usuarios globais]].',
	'centralauth-admin-hide-button'                   => 'Agochar esta conta',
	'centralauth-admin-hide-success'                  => 'Agochou con éxito a conta global de "<nowiki>$1</nowiki>"',
	'centralauth-admin-hide-nonexistent'              => 'Erro: non existe a conta global de "<nowiki>$1</nowiki>".',
	'centralauth-admin-unhide-title'                  => 'Descubrir unha conta',
	'centralauth-admin-unhide-description'            => 'Se descubre a conta fará que volva aparecer en [[Special:GlobalUsers|usuarios globais]].',
	'centralauth-admin-unhide-button'                 => 'Descubrir esta conta',
	'centralauth-admin-unhide-success'                => 'Descubriu con éxito a conta global de "<nowiki>$1</nowiki>"',
	'centralauth-admin-unhide-nonexistent'            => 'Erro: non existe a conta global de "<nowiki>$1</nowiki>".',
	...
	'centralauth-login-progress'                      => 'Accedendo ao sistema nos outros proxectos Wikimedia:',
	'centralauth-logout-progress'                     => 'Saíndo do sistema dos outros proxectos Wikimedia:',
	...
	'centralauth-log-entry-hide'                      => 'agochou a conta global de "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-unhide'                    => 'descubriu a conta global de "<nowiki>$1</nowiki>"',
...
אם אתם בעלי החשבון, באפשרותכם לסיים את תהליך מיזוג החשבונות פשוט על־ידי הקלדת הסיסמה של החשבון הכללי כאן:',
	...
	'centralauth-admin-hide-title'                    => 'הסתרת חשבון',
	'centralauth-admin-hide-description'              => 'חשבונות מוסתרים אינם מוצגים בדף [[Special:GlobalUsers]].',
	'centralauth-admin-hide-button'                   => 'הסתרת חשבון זה',
	'centralauth-admin-hide-success'                  => 'הסתרת החשבון הכללי בשם "<nowiki>$1</nowiki>" הושלמה בהצלחה.',
	'centralauth-admin-hide-nonexistent'              => 'שגיאה: לא קיים חשבון כללי בשם "<nowiki>$1</nowiki>".',
	'centralauth-admin-unhide-title'                  => 'ביטול הסתרת חשבון',
	'centralauth-admin-unhide-description'            => 'ביטול הסתרת חשבון תגרום לו להופיע שנית בדף [[Special:GlobalUsers]].',
	'centralauth-admin-unhide-button'                 => 'ביטול הסתרת חשבון זה',
	'centralauth-admin-unhide-success'                => 'ביטול הסתרת החשבון הכללי בשם "<nowiki>$1</nowiki>" הושלמה בהצלחה.',
	'centralauth-admin-unhide-nonexistent'            => 'שגיאה: לא קיים חשבון כללי בשם "<nowiki>$1</nowiki>".',
	'centralauth-admin-markasmigrating-title'         => 'סימון כחשבון במיזוג',
	'centralauth-admin-markasmigrating-description'   => 'אם החשבון במצב מיזוג, ביורוקרטים מקומיים יכולים לשנות שמות של חשבונות אחרים לשם המשתמש שלו.',
	'centralauth-admin-markasmigrating-button'        => 'סימון כחשבון במיזוג',
	'centralauth-admin-markasmigrating-success'       => 'סימון החשבון הכללי בשם "<nowiki>$1</nowiki>" כחשבון במיזוג הושלם בהצלחה.',
	'centralauth-admin-markasmigrating-nonexistent'   => 'שגיאה: לא קיים חשבון כללי בשם "<nowiki>$1</nowiki>".',
	'centralauth-admin-unmarkasmigrating-title'       => 'ביטול הסימון כחשבון במיזוג',
	'centralauth-admin-unmarkasmigrating-description' => 'מאפשר לבטל את סימון החשבון במצב מיזוג.',
	'centralauth-admin-unmarkasmigrating-button'      => 'ביטול הסימון כחשבון במיזוג',
	'centralauth-admin-unmarkasmigrating-success'     => 'ביטול סימון החשבון הכללי בשם "<nowiki>$1</nowiki>" כחשבון במיזוג הושלם בהצלחה.',
	'centralauth-admin-unmarkasmigrating-nonexistent' => 'שגיאה: לא קיים חשבון כללי בשם "<nowiki>$1</nowiki>".',
	...
	'centralauth-log-entry-hide'                      => 'הסתיר את החשבון הכללי "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-unhide'                    => 'ביטול את הסתרת החשבון הכללי "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-markasmigrating'           => 'סימן את החשבון הכללי "<nowiki>$1</nowiki>" כחשבון במיזוג',
	'centralauth-log-entry-unmarkasmigrating'         => 'ביטל את סימון החשבון הכללי "<nowiki>$1</nowiki>" כחשבון במיזוג',
...
अगर यह आप ही हैं, तो आप उस अकाउंटका मुख्य कूटशब्द यहां देकर लॉग इन एकत्रिकरण प्रक्रिया को पूरा कर सकतें हैं:',
	...
	'centralauth-error-locked'                        => 'आपके खाते को लॉक किया हुआ हैं, इसलिये आप बदलाव नहीं कर सकतें।',
...
स्थानिक खातोंके एकत्रिकरण करने से पहले के कूटशब्द पूर्ववत कर दिये जायेंगे।',
	...
	'centralauth-admin-hide-title'                    => 'खाता छुपायें',
	'centralauth-admin-hide-description'              => 'छुपायें हुए अकाउंट [[Special:GlobalUsers|वैश्विक सदस्यसूची]]में नहीं दर्शायें जायेंगे।',
	'centralauth-admin-hide-button'                   => 'यह अकाउंट छुपायें',
	'centralauth-admin-hide-success'                  => '"<nowiki>$1</nowiki>" का वैश्विक अकाउंट छुपाया गया हैं',
	'centralauth-admin-hide-nonexistent'              => 'गलती: "<nowiki>$1</nowiki>" वैश्विक अकाउंट अस्तित्वमें नहीं।',
	'centralauth-admin-unhide-title'                  => 'खाता दर्शायें',
	'centralauth-admin-unhide-description'            => 'खाता दर्शाने से [[Special:GlobalUsers|वैश्विक सदस्यसूची]]में दर्शायें जायेंगे।',
	'centralauth-admin-unhide-button'                 => 'यह अकाउंट दर्शायें',
	'centralauth-admin-unhide-success'                => '"<nowiki>$1</nowiki>" के वैश्विक अकाउंट को अनहिड कर दिया गया हैं',
	'centralauth-admin-unhide-nonexistent'            => 'गलती: "<nowiki>$1</nowiki>" वैश्विक अकाउंट अस्तित्वमें नहीं।',
...
आपने यह पृष्ठ कोईभी ज़ानकारी दिये बिना मँगाया हैं, इसलिये यह कुछ नहीं करेगा।',
	...
	'centralauth-log-entry-hide'                      => '"<nowiki>$1</nowiki>" वैश्विक अकाउंट छुपायें',
	'centralauth-log-entry-unhide'                    => '"<nowiki>$1</nowiki>" वैश्विक अकाउंट दर्शायें',
...
A helyi fiókok jelszavai visszaállnak az egyesítés előtti értékükre.',
	...
	'centralauth-login-progress'                      => 'Bejelentkeztetlek a Wikimedia többi projektjébe is:',
	'centralauth-logout-progress'                     => 'Kijelentkeztetlek a Wikimedia többi projektjéből is:',
...
$messages['id'] = array(
	...
	'centralauth-desc'                                => '[[Special:MergeAccount|Menggabungkan akun]] dari proyek-proyek wiki Wikimedia Foundation',
	...
	'centralauth-merge-welcome'                       => "'''Akun pengguna Anda belum dimigrasikan ke dalam sistem akun global Wikimedia.'''
...
nama pengguna dan kata sandi yang sama dapat digunakan di Wikipedia, Wiktionary, Wikibooks, dan proyek-proyek lainnya dalam semua bahasa.',
	'centralauth-incomplete-text'                     => 'Setelah akun Anda diubah menjadi akun global, Anda akan dapat masuk log ke situs wiki Wikimedia manapun tanpa harus membuat akun baru;
nama pengguna dan kata sandi yang sama akan dapat digunakan di Wikipedia, Wiktionary, Wikibooks, dan proyek-proyek lainnya dalam semua bahasa.',
...
Anda dapat mengganti wiki utama mana yang hendak Anda gunakan kelak.',
	...
	'centralauth-merge-method-primary'                => 'wiki utama',
...
Akun-akun lain belum dikonfirmasikan.',
	...
	'centralauth-attach-list-attached'                => 'Akun global dengan nama "$1" mencakup akun-akun berikut:',
...
Kata sandi untuk akun-akun lokal secara otomatis kembali ke kata sandi sebelum penggabungan.',
	...
	'centralauth-admin-hide-button'                   => 'Sembunyikan akun ini',
	'centralauth-admin-hide-success'                  => 'Akun global "<nowiki>$1</nowiki>" berhasil disembunyikan',
	'centralauth-admin-hide-nonexistent'              => 'Kesalahan: akun global "<nowiki>$1</nowiki>" tidak ditemukan.',
	'centralauth-admin-unhide-title'                  => 'Tampilkan akun',
	'centralauth-admin-unhide-description'            => 'Membatalkan penyembunyian akun akan menampilkannya lagi di [[Special:GlobalUsers|daftar pengguna Global]].',
	'centralauth-admin-unhide-button'                 => 'Tampilkan akun ini',
	'centralauth-admin-unhide-success'                => 'Akun global "<nowiki>$1</nowiki>" berhasil kembali ditampilkan.',
	'centralauth-admin-unhide-nonexistent'            => 'Kesalahan: akun global "<nowiki>$1</nowiki>" tidak ditemukan.',
	...
	'centralauth-prefs-not-managed'                   => 'Tidak menggunakan akun global',
...
Ketika Anda [[Special:UserLogin|masuk log]], sistem masuk log terpusat menginstruksikan penjelajah web Anda untuk mengakses halaman ini dari semua domain yang terhubungkan, menggunakan pranala berkas.
...
$messages['kk-arab'] = array(
	...
	'centralauth-merge-notlogged'    => 'تىركەلگىلەرىڭىز تولىق بىرىكتەلگەنىن تەكسەرۋ ٴۇشىن <span class="plainlinks">[{{fullurl:Special:Userlogin|returnto=Special%3AMergeAccount}} كىرىڭىز]</span>.',
...
بۇل نارسەلەر جارايتىنىن ٴوزىڭىز قۇپتاعانشا دەيىن ەش وزگەرىستەر جاسالمايدى.',
	'centralauth-merge-step1-submit' => 'تىركەلگى دەرەكتەرىن قۇپتاۋ',

	'centralauth-merge-step2-title'  => 'كوبىرەك تىركەلگىلەردى قۇپتاۋ',
	'centralauth-merge-step2-detail' => 'تىركەلگىلەردىڭ كەيبىرەۋلەرى كەلتىرىلگەن مەكەن ۋىيكىيىڭىزگە وزدىكتىك سايكەستىرىلمەدى.
ەگەر وسى تىركەلگىلەر سىزگە ٴتان بولسا, قۇپىييا ٴسوزىڭىزدى جەتىستىرىپ بۇلار سىزدىكى ەكەنىن قۇپتاي الاسىز.',
	'centralauth-merge-step2-submit' => 'تىركەلگى دەرەكتەرىن قۇپتاۋ',

	// Dry run messages
	'centralauth-merge-dryrun-complete'   => 'بارلىق بار تىركەلگىلەر وزدىكتىك بىرىزدەندىرىلۋى مۇمكىن!

تىركەلگىلەرىڭىزگە ٴالى دە ەش وزگەرىستەر جاسالعان جوق.',
	'centralauth-merge-dryrun-incomplete' => "جالعاستىرۋن تاڭداعانسىز, بىراق كەيبىر تىركەلگىلەر دەرەۋ وزدىكتىك راستالمايدى جانە كوشپەيدى.
بۇلاردى سوڭىرا بىرىكتىرە الاسىز.

تىركەلگىلەرىڭىزگە ٴالى دە ەش وزگەرىستەر جاسالعان جوق.",
	'centralauth-merge-dryrun-or'         => "'''نەمەسە'''",
	'centralauth-merge-dryrun-home'       => "قاتىسۋشى اتىڭىزدىڭ مەكەن ۋىيكىي تىركەلگىسى ىييەسى ەكەنىڭىزدى كوشۋ جۇيەسى قۇپتامادى.

قاتىسۋشى اتىڭىزدىڭ مەكەن ۋىيكىي تىركەلگىسى بولىپ وزگە ۋىيكىي انىقتالدى; تىركەلگىڭىز كوشۋىن ٴبىتىرۋ ٴۇشىن كەلەسى سىلتەمەگە ەرىڭىز دە وسىعان كىرىڭىز.",

	'centralauth-merge-step3-title'  => 'بىرىزدەندىرىلگەن تىركەلگى جاراتۋ',
	'centralauth-merge-step3-detail' => 'بىرىزدەندىرىلگەن تىركەلگىڭىزدى, كەلەسى تىركەسكەن ۋىيكىيلەرمەن, جاراتۋعا دايىنسىز:',
	'centralauth-merge-step3-submit' => 'تىركەلگىلەردى بىرىزدەندىرۋ',
...
بۇل ٴوزىڭىز بولساڭىز, تىركەلگى بىرىزدەندىرۋ ۇدەرىسىن ٴبىتىرۋ ٴۇشىن, باسقى قۇپىييا ٴسوزىڭىزدى كادىمگىدەي مىندا ەنگىزىڭىز:',
	...
	'centralauth-list-home-dryrun'      => 'بۇل ۋىيكىيدە ەنگىزىلگەن قۇپىييا ٴسوز بەن ە-پوشتا مەكەنجايى بىرىزدەندىرىلگەن تىركەلگىڭىز ٴۇشىن پايدالانىلادى.
ۋىيكىيلەرىڭىزدىڭ قايسىسى مەكەن ۋىيكىي دەپ سوڭىرا وزگەرتە الاسىز.',
	'centralauth-list-attached-title'   => 'تىركەسكەن تىركەلگىلەر',
	'centralauth-list-attached'         => 'ٴاربىر كەلەسى توراپتاردا «$1» دەپ اتالعان تىركەلگى بىرىزدەندىرىلگەن تىركەلىگە وزدىكتىك تىركەسكەن:',
	'centralauth-list-attached-dryrun'  => 'ٴاربىر كەلەسى توراپتار اراسىنداعى «$1» دەپ اتالعان تىركەلگى بىرىزدەندىرىلگەن تىركەلىگە وزدىكتىك تىركەسەدى:',
	'centralauth-list-unattached-title' => 'تىركەسپەگەن تىركەلگىلەر',
	'centralauth-list-unattached'       => 'كەلەسى توراپتاردا «$1» دەگەن تىركەلگى سىزگە ٴتاڭ دەپ وزدىكتىك قۇپتالمادى;
بۇلاردا باسقى تىركەلگىدەگىدەن وزگە قۇپىييا ٴسوزى بولۋى ەڭ ىقتىيمال:',
	'centralauth-foreign-link'          => '$2 دەگەندەگى $1 قاتىسۋشىسى',

	// Merge methods
	'centralauth-merge-method-primary'  => 'مەكەن ۋىيكىي',
	'centralauth-merge-method-empty'    => 'ەش ۇلەستەر جوق',
	'centralauth-merge-method-mail'     => 'ە-پوشتامەن قۇپتالعان',
	...
	'centralauth-finish-problems'          => 'ولقىلىقتارىڭىز بار ما, نە وسى باسقا تىركەلگىلەردىڭ ىييەسى ٴوزىڭىز ەمەس پە?
[[meta:Help:Unified login problems|كومەك قالاي تابىلادى]]…',
	'centralauth-finish-noconfirms'        => 'بۇل قۇپىييا ٴسوزدى قولدانىپ ەش تىركەلگى قۇپتالمادى.',
	'centralauth-finish-incomplete'        => 'بۇل قۇپىييا ٴسوزدى قولدانىپ بىرنەشە تىركەلگى بىرىكتىرىلدى.
Other accounts are not yet confirmed.',

	'centralauth-merge-attempt' => "'''جەتىستىرىلگەن قۇپىييا ٴسوزدى قالعان بىرىكتىرىلمەگەن تىركەلگىلەر قاراي تەكسەرۋدە…'''",

	# When unattached, offer to attach...
	'centralauth-attach-list-attached' => '«$1» دەپ اتالعان بىرىزدەندىرىلگەن تىركەلگىگە كەلەسى تىركەلگىلەر ەنەدى:',
	'centralauth-attach-title'         => 'تىركەلگىنى قۇپتاۋ',
	'centralauth-attach-text'          => 'بۇل تىركەلگى ٴالى دە بىرىزدەندىرىلگەن تىركەلگىگە كوشكەن جوق.
ەگەر عالامدىق تىركەلگى ٴدال وسىنداي سىزگە ٴتان بولسا, بۇل تىركەلگىنى بىرىكتىرۋ ٴۇشىن مىندا عالامدىق تىركەلگىنىڭ قۇپىييا ٴسوزىن ەنگىزىڭىز:',
	...
	'centralauth-admin-no-unified'         => 'بۇل قاتىسۋشى اتى ٴۇشىن ەش بىرىزدەندىرىلگەن تىركەلگى جوق.',
	...
	'centralauth-admin-attached'           => 'تولىق بىرىكتىرىلگەن تىركەلگىلەر',
	'centralauth-admin-unattached'         => 'تىركەسپەگەن تىركەلگىلەر',
	'centralauth-admin-no-unattached'      => 'ەش تىركەسپەگەن تىركەلگى قالعان جوق.',
	...
	'centralauth-admin-unmerge'            => 'بولەكتەنگەندەردىڭ بىرىكتىرۋىن ٴوشىر',
	'centralauth-admin-merge'              => 'بولەكتەنگەندەردى بىرىكتىر',
	'centralauth-admin-bad-input'          => 'بىرىكتىرۋ بولەكتەنۋى جارامسىز',
	'centralauth-admin-none-selected'      => 'تۇرلەندىرۋ ٴۇشىن ەش تىركەلگى بولەكتەنبەگەن.',
	'centralauth-admin-already-unmerged'   => '$1 قالدىرىپ كەتتى, الداقاشان بىرىكتىرۋى وشىرىلگەن',
	'centralauth-admin-unmerge-success'    => '$1 تىركەلگى بىرىكتىرۋى ٴساتتى ٴوشىرىلدى',
	'centralauth-admin-delete-title'       => 'تىركەلگىنى جويۋ',
	'centralauth-admin-delete-description' => 'عالامدىق تىركەلگىنى جويىلعاندا ارقايسى عالامدىق باپتالىمدار جويىلادى, بارلىق جەرگىلىكتى تىركەلگىلەر ٴتۇيىستىرىلۋى وشىرىلەدى, جانە باسقا قاتىسۋشى الۋىنا اشىق ەتىپ عالامدىق اتاۋدى بوساتادى.
بارلىق جەرگىلىكتى تىركەلگىلەر تۇرۋىن جالعاستىرادى.
بىرىكتىرۋ الدىندا جاسالعان جەرگىلىكتى تىركەلگىلەردىڭ قۇپىييا سوزدەرى بولعان بۇرىڭعى ماعىناسىنا قايتارىلادى.',
	'centralauth-admin-delete-button'      => 'بۇل تىركەلگىنى جوي',
	'centralauth-admin-delete-success'     => '«$1» عالامدىق تىركەلگىسى ٴساتتى جويىلدى',
	'centralauth-admin-nonexistent'        => 'وسى ارادا «$1» ٴۇشىن ەش عالامدىق تىركەلگى جوق',
	'centralauth-admin-delete-nonexistent' => 'قاتە: «$1» دەگەن عالامدىق تىركەلگى جوق.',
	'centralauth-token-mismatch'           => 'عافۋ ەتىڭىز, سەسسىييا دەرەكتەرى جوعالتىلعان سەبەبىنەن ٴپىشىنىڭىزدى جونەلتۋ ۇدەرىسىن ىستەي المايمىز.',
	'centralauth-admin-lock-title'         => 'تىركەلگىنى قۇلىپتاۋ',
	'centralauth-admin-lock-description'   => 'قۇلىپتالعان تىركەلگىمەن ۋىيكىيلەردىڭ قاي-قايسىسىنا كىرۋگە امال جوق.',
	'centralauth-admin-lock-button'        => 'بۇل تىركەلگىنى قۇلىپتا',
	'centralauth-admin-lock-success'       => '«$1» عالامدىق تىركەلگىسى ٴساتتى قۇلپتالدى',
	'centralauth-admin-lock-nonexistent'   => 'قاتە: «$1» دەگەن عالامدىق تىركەلگى جوق.',
	'centralauth-admin-unlock-title'       => 'تىركەلگى قۇلىپتاۋىن ٴوشىرۋ',
	'centralauth-admin-unlock-description' => 'قۇلىپتاۋىن ٴوشىرۋ تىركەلگىمەن كىرۋگە قايتادان امال بەرەدى.',
	...
	'centralauth-listusers-nolocal'  => 'تىركەسپەگەن نە جەرگىلىكتى ەمەس',

	// Pretty timespan
	'centralauth-seconds-ago' => '$1 سەكۋند بۇرىن',
	'centralauth-minutes-ago' => '$1 ٴمىينوت بۇرىن',
	'centralauth-hours-ago'   => '$1 ساعات بۇرىن',
	'centralauth-days-ago'    => '$1 تاۋلىك بۇرىن',
	'centralauth-months-ago'  => '$1 اي بۇرىن',
	'centralauth-years-ago'   => '$1 جىل بۇرىن',

	// Info panel in preferences
	'centralauth-prefs-status'            => 'عالامدىق تىركەلگى كۇيى:',
	'centralauth-prefs-not-managed'       => 'بىرىزدەندىرىلگەن تىركەلگى قولدانبايدى',
	'centralauth-prefs-unattached'        => 'قۇپتالماعان',
	'centralauth-prefs-complete'          => 'بارلىعى رەتتە!',
	'centralauth-prefs-migration'         => 'كوشۋدە',
	'centralauth-prefs-count-attached'    => 'تىركەلگىڭىز $1 جوبا تورابىندا بەلسەندى.',
	'centralauth-prefs-count-unattached'  => 'اتىڭىز بار قۇپتالماعان تىركەلگىلەر $1 جوبادا قالىپ تۇر.',
	'centralauth-prefs-detail-unattached' => 'بۇل جوبا تورابى عالامدىق تىركەلگىگە ٴتاڭ دەپ قۇپتالماعان.',
	'centralauth-prefs-manage'            => 'عالامدىق تىركەلگىڭىزدى رەتتەۋ',

	// Interaction with Special:Renameuser
	'centralauth-renameuser-abort'  => '<div class="errorbox">$1 دەگەن قاتىسۋشى جەرگىلىكتى ورنىندا قايتا اتالمايدى, ويتكەنى بۇل قاتىسۋشى اتى بىرىزدەندىرىلگەن كىرۋ جۇيەسىنە كوشكەن.</div>',
	'centralauth-renameuser-exists' => '<div class="errorbox">$2 دەگەن قاتىسۋشى قايتا اتالمايدى, ويتكەنى بۇل قاتىسۋشى اتى عالامدىق تىركەلگى ٴۇشىن كەيىنگە ساقتالادى.</div>',
	...
	'centralauth-autologin-desc'  => 'بۇل ارنايى بەت MediaWiki ىشكى قولدانۋ ٴۇشىن ارنالادى.
[[Special:UserLogin|كىرگەنىڭىزدە]], ورتالىق كىرۋ جۇيەسى سۋرەت سىلتەمەلەرىن قولدانىپ, بارلىق سىلتەنگەن ۇيشىكتەردەن بۇل بەتتى سۇراۋ ٴۇشىن شولعىشىعىڭىزعا نۇسقامالار بەرەدى.
قايسىبىر تەڭدەستىرۋ دەرەكتەر جەتىستىرمەي بۇل بەتتى سۇراعانسىز, سودىقتان ەشتەڭە ىستەلىنبەيدى.',
	...
	'centralauth-log-entry-lock'   => '«$1» عالامدىق تىركەلگىسىن قۇلىپتادى',
	'centralauth-log-entry-unlock' => '«$1» عالامدىق تىركەلگىسىنىڭ قۇلىپتاۋىن ٴوشىردى',

	'centralauth-rightslog-name'             => 'عالامدىق قۇقىقتار جۋرنالى',
	...
	'centralauth-newgroup-intro'                      => 'بۇل ٴپىشىندى جاڭا توپقا رۇقساتتاردى ٴتۇيىستىرۋ ٴۇشىن قولدانا الاسىز. اڭعارتپا: رۇقساتتارى تۇيىستىرىلگەنشە دەيىن توپ جوق دەپ ەسەپتەلەدى.',
	'centralauth-globalgroupperms-newgroupname'       => 'جاڭا توپ اتاۋى:',
	'centralauth-globalgroupperms-creategroup-submit' => 'رۇقساتتاردى ٴتۇيىستىر',
	'centralauth-editgroup-subtitle'                  => 'وڭدەلۋدە: $1',
	'centralauth-editgroup-fieldset'                  => '$1 دەگەننىڭ رۇقساتتارى',
	'centralauth-editgroup-name'                      => 'توپ اتاۋى:',
	'centralauth-editgroup-display'                   => 'توپتىڭ جەرسىندىرىلگەن اتاۋى:',
	'centralauth-editgroup-display-edit'              => '$2 ([[MediaWiki:Group-$1|وڭدەۋ]])',
	'centralauth-editgroup-member'                    => 'توپ مۇشەلەرىنىڭ جەرسىندىرىلگەن اتاۋى:',
	...
	'centralauth-editgroup-reason'                    => 'وزگەرتۋ سەبەبى:',
	...
	'right-centralauth-merge'      => 'تىركەلگىلەرىن بىرىكتىرۋ',
...
$messages['kk-cyrl'] = array(
	...
	'centralauth-merge-notlogged'    => 'Тіркелгілеріңіз толық біріктелгенін тексеру үшін <span class="plainlinks">[{{fullurl:Special:Userlogin|returnto=Special%3AMergeAccount}} кіріңіз]</span>.',
...
Бұл [http://commons.wikimedia.org/ Wikimedia Ортаққорына] қотарып беру сияқты ортақтастырылған жобалармен жұмыс істеуге жеңілдетеді, және өзге жобаларда екі тұлға бір қатысушы атын пайдаланғаннан шығатын былықтан не қақтығыстан тайдырады.
...
Бұл нәрселер жарайтынын өзіңіз құптағанша дейін еш өзгерістер жасалмайды.',
	'centralauth-merge-step1-submit' => 'Тіркелгі деректерін құптау',
...
Тіркелгілеріңізге әлі де еш өзгерістер жасалған жоқ.',
	'centralauth-merge-dryrun-incomplete' => "Жалғастырун таңдағансыз, бірақ кейбір тіркелгілер дереу өздіктік расталмайды және көшпейді.
Бұларды соңыра біріктіре аласыз.

Тіркелгілеріңізге әлі де еш өзгерістер жасалған жоқ.",
	'centralauth-merge-dryrun-or'         => "'''немесе'''",
	'centralauth-merge-dryrun-home'       => "Қатысушы атыңыздың мекен уики тіркелгісі иесі екеніңізді көшу жүйесі құптамады.

Қатысушы атыңыздың мекен уики тіркелгісі болып өзге уики анықталды; тіркелгіңіз көшуін бітіру үшін келесі сілтемеге еріңіз де осыған кіріңіз.",

	'centralauth-merge-step3-title'  => 'Біріздендірілген тіркелгі жарату',
	'centralauth-merge-step3-detail' => 'Біріздендірілген тіркелгіңізді, келесі тіркескен уикилермен, жаратуға дайынсыз:',
	'centralauth-merge-step3-submit' => 'Тіркелгілерді біріздендіру',
...
Уикилеріңіздің қайсысы мекен уики деп соңыра өзгерте аласыз.',
	'centralauth-list-attached-title'   => 'Тіркескен тіркелгілер',
	'centralauth-list-attached'         => 'Әрбір келесі тораптарда «$1» деп аталған тіркелгі біріздендірілген тіркеліге өздіктік тіркескен:',
	'centralauth-list-attached-dryrun'  => 'Әрбір келесі тораптар арасындағы «$1» деп аталған тіркелгі біріздендірілген тіркеліге өздіктік тіркеседі:',
	'centralauth-list-unattached-title' => 'Тіркеспеген тіркелгілер',
	'centralauth-list-unattached'       => 'Келесі тораптарда «$1» деген тіркелгі сізге тәң деп өздіктік құпталмады;
бұларда басқы тіркелгідегіден өзге құпия сөзі болуы ең ықтимал:',
	'centralauth-foreign-link'          => '$2 дегендегі $1 қатысушысы',

	// Merge methods
	'centralauth-merge-method-primary'  => 'мекен уики',
	'centralauth-merge-method-empty'    => 'еш үлестер жоқ',
	'centralauth-merge-method-mail'     => 'е-поштамен құпталған',
	...
	'centralauth-finish-problems'          => 'Олқылықтарыңыз бар ма, не осы басқа тіркелгілердің иесі өзіңіз емес пе?
[[meta:Help:Unified login problems|Көмек қалай табылады]]…',
	'centralauth-finish-noconfirms'        => 'Бұл құпия сөзді қолданып еш тіркелгі құпталмады.',
	'centralauth-finish-incomplete'        => 'Бұл құпия сөзді қолданып бірнеше тіркелгі біріктірілді.
Other accounts are not yet confirmed.',

	'centralauth-merge-attempt' => "'''Жетістірілген құпия сөзді қалған біріктірілмеген тіркелгілер қарай тексеруде…'''",

	# When unattached, offer to attach...
	'centralauth-attach-list-attached' => '«$1» деп аталған біріздендірілген тіркелгіге келесі тіркелгілер енеді:',
	'centralauth-attach-title'         => 'Тіркелгіні құптау',
	'centralauth-attach-text'          => 'Бұл тіркелгі әлі де біріздендірілген тіркелгіге көшкен жоқ.
Егер ғаламдық тіркелгі дәл осындай сізге тән болса, бұл тіркелгіні біріктіру үшін мында ғаламдық тіркелгінің құпия сөзін енгізіңіз:',
	...
	'centralauth-admin-no-unified'         => 'Бұл қатысушы аты үшін еш біріздендірілген тіркелгі жоқ.',
	...
	'centralauth-admin-attached'           => 'Толық біріктірілген тіркелгілер',
	'centralauth-admin-unattached'         => 'Тіркеспеген тіркелгілер',
	'centralauth-admin-no-unattached'      => 'Еш тіркеспеген тіркелгі қалған жоқ.',
	...
	'centralauth-admin-unmerge'            => 'Бөлектенгендердің біріктіруін өшір',
	'centralauth-admin-merge'              => 'Бөлектенгендерді біріктір',
	'centralauth-admin-bad-input'          => 'Біріктіру бөлектенуі жарамсыз',
	'centralauth-admin-none-selected'      => 'Түрлендіру үшін еш тіркелгі бөлектенбеген.',
	'centralauth-admin-already-unmerged'   => '$1 қалдырып кетті, алдақашан біріктіруі өшірілген',
	'centralauth-admin-unmerge-success'    => '$1 тіркелгі біріктіруі сәтті өшірілді',
	'centralauth-admin-delete-title'       => 'Тіркелгіні жою',
	'centralauth-admin-delete-description' => 'Ғаламдық тіркелгіні жойылғанда әрқайсы ғаламдық бапталымдар жойылады, барлық жергілікті тіркелгілер түйістірілуі өшіріледі, және басқа қатысушы алуына ашық етіп ғаламдық атауды босатады.
Барлық жергілікті тіркелгілер тұруын жалғастырады.
Біріктіру алдында жасалған жергілікті тіркелгілердің құпия сөздері болған бұрыңғы мағынасына қайтарылады.',
	'centralauth-admin-delete-button'      => 'Бұл тіркелгіні жой',
	'centralauth-admin-delete-success'     => '«<nowiki>$1</nowiki>» ғаламдық тіркелгісі сәтті жойылды',
	'centralauth-admin-nonexistent'        => 'Осы арада «<nowiki>$1</nowiki>» үшін еш ғаламдық тіркелгі жоқ',
	'centralauth-admin-delete-nonexistent' => 'Қате: «<nowiki>$1</nowiki>» деген ғаламдық тіркелгі жоқ.',
	'centralauth-token-mismatch'           => 'Ғафу етіңіз, сессия деректері жоғалтылған себебінен пішініңізді жөнелту үдерісін істей алмаймыз.',
	'centralauth-admin-lock-title'         => 'Тіркелгіні құлыптау',
	'centralauth-admin-lock-description'   => 'Құлыпталған тіркелгімен уикилердің қай-қайсысына кіруге амал жоқ.',
	'centralauth-admin-lock-button'        => 'Бұл тіркелгіні құлыпта',
	'centralauth-admin-lock-success'       => '«<nowiki>$1</nowiki>» ғаламдық тіркелгісі сәтті құлпталды',
	'centralauth-admin-lock-nonexistent'   => 'Қате: «<nowiki>$1</nowiki>» деген ғаламдық тіркелгі жоқ.',
	'centralauth-admin-unlock-title'       => 'Тіркелгі құлыптауын өшіру',
	'centralauth-admin-unlock-description' => 'Құлыптауын өшіру тіркелгімен кіруге қайтадан амал береді.',
	...
	'centralauth-listusers-nolocal'  => 'тіркеспеген не жергілікті емес',

	// Pretty timespan
	'centralauth-seconds-ago' => '$1 секунд бұрын',
	'centralauth-minutes-ago' => '$1 минөт бұрын',
	'centralauth-hours-ago'   => '$1 сағат бұрын',
	'centralauth-days-ago'    => '$1 тәулік бұрын',
	'centralauth-months-ago'  => '$1 ай бұрын',
	'centralauth-years-ago'   => '$1 жыл бұрын',

	// Info panel in preferences
	'centralauth-prefs-status'            => 'Ғаламдық тіркелгі күйі:',
	'centralauth-prefs-not-managed'       => 'Біріздендірілген тіркелгі қолданбайды',
	'centralauth-prefs-unattached'        => 'Құпталмаған',
	'centralauth-prefs-complete'          => 'Барлығы ретте!',
	'centralauth-prefs-migration'         => 'Көшуде',
	'centralauth-prefs-count-attached'    => 'Тіркелгіңіз $1 жоба торабында белсенді.',
	...
	// Interaction with Special:Renameuser
	'centralauth-renameuser-abort'  => '<div class="errorbox">$1 деген қатысушы жергілікті орнында қайта аталмайды, өйткені бұл қатысушы аты біріздендірілген кіру жүйесіне көшкен.</div>',
	'centralauth-renameuser-exists' => '<div class="errorbox">$2 деген қатысушы қайта аталмайды, өйткені бұл қатысушы аты ғаламдық тіркелгі үшін кейінге сақталады.</div>',
...
Қайсыбір теңдестіру деректер жетістірмей бұл бетті сұрағансыз, содықтан ештеңе істелінбейді.',
	...
	'centralauth-log-entry-delete' => '«<nowiki>$1</nowiki>» ғаламдық тіркелгісін жойды',
	'centralauth-log-entry-lock'   => '«<nowiki>$1</nowiki>» ғаламдық тіркелгісін құлыптады',
	'centralauth-log-entry-unlock' => '«<nowiki>$1</nowiki>» ғаламдық тіркелгісінің құлыптауын өшірді',

	'centralauth-rightslog-name'             => 'Ғаламдық құқықтар журналы',
	...
	'centralauth-newgroup-intro'                      => 'Бұл пішінді жаңа топқа рұқсаттарды түйістіру үшін қолдана аласыз. Аңғартпа: рұқсаттары түйістірілгенше дейін топ жоқ деп есептеледі.',
	'centralauth-globalgroupperms-newgroupname'       => 'Жаңа топ атауы:',
	'centralauth-globalgroupperms-creategroup-submit' => 'Рұқсаттарды түйістір',
	'centralauth-editgroup-subtitle'                  => 'Өңделуде: $1',
	'centralauth-editgroup-fieldset'                  => '$1 дегеннің рұқсаттары',
	'centralauth-editgroup-name'                      => 'Топ атауы:',
	'centralauth-editgroup-display'                   => 'Топтың жерсіндірілген атауы:',
	'centralauth-editgroup-display-edit'              => '$2 ([[MediaWiki:Group-$1|өңдеу]])',
	'centralauth-editgroup-member'                    => 'Топ мүшелерінің жерсіндірілген атауы:',
	...
	'centralauth-editgroup-reason'                    => 'Өзгерту себебі:',
...
$messages['kk-latn'] = array(
	...
	'centralauth-merge-notlogged'    => 'Tirkelgileriñiz tolıq biriktelgenin tekserw üşin <span class="plainlinks">[{{fullurl:Special:Userlogin|returnto=Special%3AMergeAccount}} kiriñiz]</span>.',
...
Bul närseler jaraýtının öziñiz quptağanşa deýin eş özgerister jasalmaýdı.',
	'centralauth-merge-step1-submit' => 'Tirkelgi derekterin quptaw',

	'centralauth-merge-step2-title'  => 'Köbirek tirkelgilerdi quptaw',
	'centralauth-merge-step2-detail' => 'Tirkelgilerdiñ keýbirewleri keltirilgen meken wïkïiñizge özdiktik säýkestirilmedi.
Eger osı tirkelgiler sizge tän bolsa, qupïya söziñizdi jetistirip bular sizdiki ekenin quptaý alasız.',
	'centralauth-merge-step2-submit' => 'Tirkelgi derekterin quptaw',

	// Dry run messages
	'centralauth-merge-dryrun-complete'   => 'Barlıq bar tirkelgiler özdiktik birizdendirilwi mümkin!

Tirkelgileriñizge äli de eş özgerister jasalğan joq.',
	'centralauth-merge-dryrun-incomplete' => "Jalğastırwn tañdağansız, biraq keýbir tirkelgiler derew özdiktik rastalmaýdı jäne köşpeýdi.
Bulardı soñıra biriktire alasız.

Tirkelgileriñizge äli de eş özgerister jasalğan joq.",
	'centralauth-merge-dryrun-or'         => "'''nemese'''",
	'centralauth-merge-dryrun-home'       => "Qatıswşı atıñızdıñ meken wïkï tirkelgisi ïesi ekeniñizdi köşw jüýesi quptamadı.

Qatıswşı atıñızdıñ meken wïkï tirkelgisi bolıp özge wïkï anıqtaldı; tirkelgiñiz köşwin bitirw üşin kelesi siltemege eriñiz de osığan kiriñiz.",

	'centralauth-merge-step3-title'  => 'Birizdendirilgen tirkelgi jaratw',
	'centralauth-merge-step3-detail' => 'Birizdendirilgen tirkelgiñizdi, kelesi tirkesken wïkïlermen, jaratwğa daýınsız:',
	'centralauth-merge-step3-submit' => 'Tirkelgilerdi birizdendirw',
...
Bul öziñiz bolsañız, tirkelgi birizdendirw üderisin bitirw üşin, basqı qupïya söziñizdi kädimgideý mında engiziñiz:',
	...
	'centralauth-list-home-dryrun'      => 'Bul wïkïde engizilgen qupïya söz ben e-poşta mekenjaýı birizdendirilgen tirkelgiñiz üşin paýdalanıladı.
Wïkïleriñizdiñ qaýsısı meken wïkï dep soñıra özgerte alasız.',
	'centralauth-list-attached-title'   => 'Tirkesken tirkelgiler',
	'centralauth-list-attached'         => 'Ärbir kelesi toraptarda «$1» dep atalğan tirkelgi birizdendirilgen tirkelige özdiktik tirkesken:',
	'centralauth-list-attached-dryrun'  => 'Ärbir kelesi toraptar arasındağı «$1» dep atalğan tirkelgi birizdendirilgen tirkelige özdiktik tirkesedi:',
	'centralauth-list-unattached-title' => 'Tirkespegen tirkelgiler',
	'centralauth-list-unattached'       => 'Kelesi toraptarda «$1» degen tirkelgi sizge täñ dep özdiktik quptalmadı;
bularda basqı tirkelgidegiden özge qupïya sözi bolwı eñ ıqtïmal:',
	'centralauth-foreign-link'          => '$2 degendegi $1 qatıswşısı',

	// Merge methods
	'centralauth-merge-method-primary'  => 'meken wïkï',
	'centralauth-merge-method-empty'    => 'eş ülester joq',
	'centralauth-merge-method-mail'     => 'e-poştamen quptalğan',
	...
	'centralauth-finish-problems'          => 'Olqılıqtarıñız bar ma, ne osı basqa tirkelgilerdiñ ïesi öziñiz emes pe?
[[meta:Help:Unified login problems|Kömek qalaý tabıladı]]…',
	'centralauth-finish-noconfirms'        => 'Bul qupïya sözdi qoldanıp eş tirkelgi quptalmadı.',
	'centralauth-finish-incomplete'        => 'Bul qupïya sözdi qoldanıp birneşe tirkelgi biriktirildi.
Other accounts are not yet confirmed.',

	'centralauth-merge-attempt' => "'''Jetistirilgen qupïya sözdi qalğan biriktirilmegen tirkelgiler qaraý tekserwde…'''",

	# When unattached, offer to attach...
	'centralauth-attach-list-attached' => '«$1» dep atalğan birizdendirilgen tirkelgige kelesi tirkelgiler enedi:',
	'centralauth-attach-title'         => 'Tirkelgini quptaw',
	'centralauth-attach-text'          => 'Bul tirkelgi äli de birizdendirilgen tirkelgige köşken joq.
Eger ğalamdıq tirkelgi däl osındaý sizge tän bolsa, bul tirkelgini biriktirw üşin mında ğalamdıq tirkelginiñ qupïya sözin engiziñiz:',
	...
	'centralauth-admin-no-unified'         => 'Bul qatıswşı atı üşin eş birizdendirilgen tirkelgi joq.',
	...
	'centralauth-admin-attached'           => 'Tolıq biriktirilgen tirkelgiler',
	'centralauth-admin-unattached'         => 'Tirkespegen tirkelgiler',
	'centralauth-admin-no-unattached'      => 'Eş tirkespegen tirkelgi qalğan joq.',
	...
	'centralauth-admin-unmerge'            => 'Bölektengenderdiñ biriktirwin öşir',
	'centralauth-admin-merge'              => 'Bölektengenderdi biriktir',
	'centralauth-admin-bad-input'          => 'Biriktirw bölektenwi jaramsız',
	'centralauth-admin-none-selected'      => 'Türlendirw üşin eş tirkelgi bölektenbegen.',
	'centralauth-admin-already-unmerged'   => '$1 qaldırıp ketti, aldaqaşan biriktirwi öşirilgen',
	'centralauth-admin-unmerge-success'    => '$1 tirkelgi biriktirwi sätti öşirildi',
	'centralauth-admin-delete-title'       => 'Tirkelgini joyw',
	'centralauth-admin-delete-description' => 'Ğalamdıq tirkelgini joýılğanda ärqaýsı ğalamdıq baptalımdar joýıladı, barlıq jergilikti tirkelgiler tüýistirilwi öşiriledi, jäne basqa qatıswşı alwına aşıq etip ğalamdıq atawdı bosatadı.
Barlıq jergilikti tirkelgiler turwın jalğastıradı.
Biriktirw aldında jasalğan jergilikti tirkelgilerdiñ qupïya sözderi bolğan burıñğı mağınasına qaýtarıladı.',
	'centralauth-admin-delete-button'      => 'Bul tirkelgini joý',
	'centralauth-admin-delete-success'     => '«<nowiki>$1</nowiki>» ğalamdıq tirkelgisi sätti joýıldı',
	'centralauth-admin-nonexistent'        => 'Osı arada «<nowiki>$1</nowiki>» üşin eş ğalamdıq tirkelgi joq',
	'centralauth-admin-delete-nonexistent' => 'Qate: «<nowiki>$1</nowiki>» degen ğalamdıq tirkelgi joq.',
	'centralauth-token-mismatch'           => 'Ğafw etiñiz, sessïya derekteri joğaltılğan sebebinen pişiniñizdi jöneltw üderisin isteý almaýmız.',
	'centralauth-admin-lock-title'         => 'Tirkelgini qulıptaw',
	'centralauth-admin-lock-description'   => 'Qulıptalğan tirkelgimen wïkïlerdiñ qaý-qaýsısına kirwge amal joq.',
	'centralauth-admin-lock-button'        => 'Bul tirkelgini qulıpta',
	'centralauth-admin-lock-success'       => '«<nowiki>$1</nowiki>» ğalamdıq tirkelgisi sätti qulptaldı',
	'centralauth-admin-lock-nonexistent'   => 'Qate: «<nowiki>$1</nowiki>» degen ğalamdıq tirkelgi joq.',
	'centralauth-admin-unlock-title'       => 'Tirkelgi qulıptawın öşirw',
	'centralauth-admin-unlock-description' => 'Qulıptawın öşirw tirkelgimen kirwge qaýtadan amal beredi.',
	...
	'centralauth-listusers-nolocal'  => 'tirkespegen ne jergilikti emes',

	// Pretty timespan
	'centralauth-seconds-ago' => '$1 sekwnd burın',
	'centralauth-minutes-ago' => '$1 mïnöt burın',
	'centralauth-hours-ago'   => '$1 sağat burın',
	'centralauth-days-ago'    => '$1 täwlik burın',
	'centralauth-months-ago'  => '$1 aý burın',
	'centralauth-years-ago'   => '$1 jıl burın',

	// Info panel in preferences
	'centralauth-prefs-status'            => 'Ğalamdıq tirkelgi küýi:',
	'centralauth-prefs-not-managed'       => 'Birizdendirilgen tirkelgi qoldanbaýdı',
	'centralauth-prefs-unattached'        => 'Quptalmağan',
	'centralauth-prefs-complete'          => 'Barlığı rette!',
	'centralauth-prefs-migration'         => 'Köşwde',
	'centralauth-prefs-count-attached'    => 'Tirkelgiñiz $1 joba torabında belsendi.',
	'centralauth-prefs-count-unattached'  => 'Atıñız bar quptalmağan tirkelgiler $1 jobada qalıp tur.',
	'centralauth-prefs-detail-unattached' => 'Bul joba torabı ğalamdıq tirkelgige täñ dep quptalmağan.',
	'centralauth-prefs-manage'            => 'Ğalamdıq tirkelgiñizdi rettew',

	// Interaction with Special:Renameuser
	'centralauth-renameuser-abort'  => '<div class="errorbox">$1 degen qatıswşı jergilikti ornında qaýta atalmaýdı, öýtkeni bul qatıswşı atı birizdendirilgen kirw jüýesine köşken.</div>',
	'centralauth-renameuser-exists' => '<div class="errorbox">$2 degen qatıswşı qaýta atalmaýdı, öýtkeni bul qatıswşı atı ğalamdıq tirkelgi üşin keýinge saqtaladı.</div>',
	...
	'centralauth-autologin-desc'  => 'Bul arnaýı bet MediaWiki işki qoldanw üşin arnaladı.
[[Special:UserLogin|Kirgeniñizde]], ortalıq kirw jüýesi swret siltemelerin qoldanıp, barlıq siltengen üýşikterden bul betti suraw üşin şolğışığıñızğa nusqamalar beredi.
Qaýsıbir teñdestirw derekter jetistirmeý bul betti surağansız, sodıqtan eşteñe istelinbeýdi.',
	...
	'centralauth-log-entry-delete' => '«<nowiki>$1</nowiki>» ğalamdıq tirkelgisin joýdı',
	'centralauth-log-entry-lock'   => '«<nowiki>$1</nowiki>» ğalamdıq tirkelgisin qulıptadı',
	'centralauth-log-entry-unlock' => '«<nowiki>$1</nowiki>» ğalamdıq tirkelgisiniñ qulıptawın öşirdi',

	'centralauth-rightslog-name'             => 'Ğalamdıq quqıqtar jwrnalı',
	...
	'centralauth-newgroup-intro'                      => 'Bul pişindi jaña topqa ruqsattardı tüýistirw üşin qoldana alasız. Añğartpa: ruqsattarı tüýistirilgenşe deýin top joq dep esepteledi.',
	'centralauth-globalgroupperms-newgroupname'       => 'Jaña top atawı:',
	'centralauth-globalgroupperms-creategroup-submit' => 'Ruqsattardı tüýistir',
	'centralauth-editgroup-subtitle'                  => 'Öñdelwde: $1',
	'centralauth-editgroup-fieldset'                  => '$1 degenniñ ruqsattarı',
	'centralauth-editgroup-name'                      => 'Top atawı:',
	'centralauth-editgroup-display'                   => 'Toptıñ jersindirilgen atawı:',
	'centralauth-editgroup-display-edit'              => '$2 ([[MediaWiki:Group-$1|öñdew]])',
	'centralauth-editgroup-member'                    => 'Top müşeleriniñ jersindirilgen atawı:',
	...
	'centralauth-editgroup-reason'                    => 'Özgertw sebebi:',
...
$messages['la'] = array(
	...
	'centralauth-login-progress'    => 'Aperiens conventa aliis in inceptis Vicimediorum:',
	'centralauth-logout-progress'   => 'Concludens conventa aliis in inceptis Vicimediorum:',
);
...
Bis elo sinn nach keng Ännerungen un äre Benotzerkonte gemaach ginn.',
	...
	'centralauth-admin-unattached'                    => 'Net verbonne Benotzerkonten',
	...
	'centralauth-log-entry-hide'                      => 'verstopp de globale Benotzerkont "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-unhide'                    => 'de globale Benotzerkont "<nowiki>$1</nowiki>" nees weisen',
...
$messages['li'] = array(
	...
	'centralauth-merge-welcome'                       => "'''Dien gebroekersaccount is nog neet gemigreerd nao 't samegevoog aanmeldsysteem van Wikimedia.'''

Es te d'rveur keus óm dien gebroekersaccounts te migrere, den kèns te dich mit dezelfde gebroekersnaam-wachwaordcombinatie aanmelje bie alle projekte van Wikimedia in alle besjikbaar täöl. Dit maak 't einvoudiger óm te wirke mit gedeilde projekte wie 't uploade nao [http://commons.wikimedia.org/ Wikimedia Commons] en veurkump verwarring of conflikte doordet twie luuj dezelfde gebroekersnaam keze op versjillende projekte.
...
Es emes angers mit diene gebroekersnaam al actief is op 'ne angere site, den haet det gein gevolge veur dae gebroeker. De höbs de mäögelikheid det mit dae gebroeker of 'ne beheerder op 'n later memènt op te losse.",
	...
	'centralauth-merge-step1-detail'                  => "Dien wachwaord en geregistreerd e-mailadres waere gecontroleerd taenge de gebroekers op anger wiki's óm te bevestige det ze euvereinkómme. D'r waere gein verangeringe gemaak tótdets te höbs aangegaeve det alles correk liek.",
...
D'r is 'ne angere wiki vasgesteld es heimwiki veur öche gebroeker; vólg de link hijónger en mèlj öch dao aan óm öche gebroekersmigratie aaf te make.",
	...
	'centralauth-merge-step3-detail'                  => "De kèns noe dien samegevoog gebroekersaccount make mit dao-in de volgende wiki's opgenómme:",
	...
	'centralauth-incomplete-text'                     => "Es dien gebroekersaccounts zeen samegevoog kèns te dich aanmelje bie jedere wiki van Wikimedia zónger 'ne nuje gebroeker aan te make; dezelfde combinatie van gebroekersnaam en wachwaord wirk veur Wikipedia, Wiktionair, Wikibeuk en hun zösterprojekter in alle täöl.",
...
Es geer det böntj, kintj geer uch \'t samevoege van gebroekers aafrönje door hiej \'t wachwaprd veur dae gebroeker te gaeve:',
	...
	'centralauth-readmore-text'                       => ":''[[meta:Help:Unified login|Laes mie euver '''samegevoog aanmelje''']]...''",
	'centralauth-list-home-title'                     => 'Thoeswiki',
	'centralauth-list-home-dryrun'                    => "'t Wachwaord en e-mailadres det veur deze wiki is ingesjtèld weurt gebroek veur dien samegevoog gebroekersaccount.
Later kèns te insjtèlle wat veur wiki diene thoeswiki is.",
...
Dėl to bus paprasčiau dirbti bendruose projektuose, pavyzdžiui [http://commons.wikimedia.org/ Vikitekoje] bei išvengsite konfliktų ir painiavos, kai du žmonės pasirenka tą patį naudotojo vardą skirtinguose projektuose.

Jei kažkas jau turi paskyrą jūsų naudotojo vardu kitame projekte, tai nepaveiks to naudotojo, tačiau jūs galėsite su juo ar su projekto admnistratoriumi aptarti paskyrų pervadinimą.",
...
Jūsų slaptažodis ir registruotas elektroninis paštas bus patikrintas kituose projektuose, ar duomenys sutampa.
Jokie pakeitimai neįvyks kol jūs nepatvirtinsite, jog viskas yra gerai.',
	...
	'centralauth-merge-step2-detail'       => 'Kaikurios paskyros negali būti automatiškai sujungtos, nes neatitinka jūsų pagrindinės wiki paskyros.
Jei šios paskyros priklauso jums, jūs galite patvirtinti, kad jos tkrai jūsų įvesdamas jų slaptažodžius.',
	'centralauth-merge-step2-submit'       => 'Patvirtinkite prisiregistravimo informaciją',
	'centralauth-merge-dryrun-complete'    => 'Visos egzistuojančios paskyros gali būti automatiškai sujungtos!

Kol kas jokie pakeitimai su jūsų paskiromis neįvyko.',
	'centralauth-merge-dryrun-incomplete'  => 'Jums galima tęsti, tačiau kaikurios paskyros negali būti automatiškai patikrintos ir nebus sujungtos netrukus.
Jūs galėsite jas sujungti vėliau.

Kol kas jokių pakeitimų su jūsų paskyromis neįvyko.',
	'centralauth-merge-dryrun-or'          => "'''ar'''",
	'centralauth-merge-dryrun-home'        => 'Perkėlimo sistema negali patvirtinti, kad jūs esate šio naudotojo vardo šeimininkas namų wiki.

Kitoje wiki nustatyta paskyra jūsų naudotojo vardui kaip namų wiki; sekite žemiau esančia nuoroda ir ten prisiregistruokite kad galėtumėte užbaigti paskyrų perkėlimą.',
	'centralauth-merge-step3-title'        => 'Sukurti vieningą paskyrą',
	'centralauth-merge-step3-detail'       => 'Jūs esate pasiruošęs sukurti vieningą paskyrą šiose wiki:',
...
tas pats naudotojo vardas ir slaptažodis veiks Vikipedijoje, Vikižodyne, Vikiknygose ir kituose seseriškuose projektuose visomis kalbomis.',
	...
	'centralauth-list-attached'            => 'Paskyra vardu "$1" kiekvienoje iš sekančių vietų buvo automatiškai priskirta unifikuotai registracijai:',
	'centralauth-list-attached-dryrun'     => 'Paskyra vardu "$1" kiekvienoje iš sekančių vietų bus automatiškai priskirta unifikuotai registracijai:',
	'centralauth-list-unattached-title'    => 'Neprijungtos paskyros',
	'centralauth-merge-method-primary'     => 'pagrindinė wiki',
	'centralauth-merge-method-empty'       => 'nėra indėlio',
	'centralauth-merge-method-mail'        => 'patvirtinta elektroniniu paštu',
	'centralauth-merge-method-password'    => 'patvirtinta slaptažodžiu',
	'centralauth-merge-method-admin'       => 'administruoti sujungtą paskyrą',
	'centralauth-merge-method-new'         => 'nauja sąskaita',
	'centralauth-merge-method-login'       => 'patvirtinta prisijungimu',
	'centralauth-finish-title'             => 'Baigti jungimą',
	'centralauth-finish-password'          => 'Slaptažodis',
	'centralauth-finish-login'             => 'Prisijungti',
	...
	'centralauth-attach-success'           => 'Paskyra buvo migruota į unifikuotą paskyrą.',
	'centralauth'                          => 'Unifikuotos registracijos valdymas',
	'centralauth-admin-manage'             => 'Naudotojo duomenų valdymas',
	'centralauth-admin-username'           => 'Naudotojo vardas:',
	'centralauth-admin-lookup'             => 'Peržiūrėti arba redaguoti naudotojo duomenis',
	'centralauth-admin-no-unified'         => 'Šis naudotojas neturi unifikuotos paskyros',
	...
	'centralauth-admin-info-hidden'        => 'Paslėptas:',
	'centralauth-admin-yes'                => 'taip',
	'centralauth-admin-no'                 => 'ne',
	'centralauth-admin-attached'           => 'Pilnai sujungtos paskyros',
	'centralauth-admin-list-localwiki'     => 'Lokalus wiki',
...
स्थानिक खात्यांचे एकत्रिकरण करण्यापूर्वीचे परवलीचे शब्द पूर्ववत होतील.',
	...
	'centralauth-admin-hide-title'                    => 'खाते लपवा',
	'centralauth-admin-hide-description'              => 'लपविलेली खाती [[Special:GlobalUsers|वैश्विक सदस्यांमध्ये]] दर्शविली जात नाहीत.',
	'centralauth-admin-hide-button'                   => 'हे खाते लपवा',
	'centralauth-admin-hide-success'                  => '"<nowiki>$1</nowiki>" चे वैश्विक खाते यशस्वीरित्या लपविण्यात आलेले आहे',
	'centralauth-admin-hide-nonexistent'              => 'त्रुटी: "<nowiki>$1</nowiki>" वैश्विक खाते अस्तित्वात नाही.',
	'centralauth-admin-unhide-title'                  => 'खाते लपविणे रद्द करा',
	'centralauth-admin-unhide-description'            => 'खाते लपविणे रद्द केल्यास [[Special:GlobalUsers|वैश्विक सदस्यांमध्ये]] पुन्हा दर्शविले जाईल.',
	'centralauth-admin-unhide-button'                 => 'ह्या खात्याचे लपविणे रद्द करा',
	'centralauth-admin-unhide-success'                => '"<nowiki>$1</nowiki>" च्या वैश्विक खात्याचे लपविणे यशस्वीरित्या रद्द केलेले आहे',
	'centralauth-admin-unhide-nonexistent'            => 'त्रुटी: "<nowiki>$1</nowiki>" वैश्विक खाते अस्तित्वात नाही.',
	'centralauth-admin-reason'                        => 'कारण:',
...
तुम्ही हे पान कुठलीही माहिती न देता मागविलेले आहे, त्यामुळे ते काहीही करणार नाही.',
	...
	'centralauth-log-entry-hide'                      => '"<nowiki>$1</nowiki>" वैश्विक खाते लपवा',
	'centralauth-log-entry-unhide'                    => '"<nowiki>$1</nowiki>" वैश्विक खाते लपविणे रद्द करा',
...
Er zijn nog gebruikers die niet bevestigd zijn.',
	...
	'centralauth-admin-hide-button'                   => 'Deze gebruiker verbergen',
	'centralauth-admin-hide-success'                  => 'De globale gebruiker "<nowiki>$1</nowiki>" is verborgen',
	'centralauth-admin-hide-nonexistent'              => 'Fout: de globale gebruiker "<nowiki>$1</nowiki>" bestaat niet.',
	'centralauth-admin-unhide-title'                  => 'Gebruiker zichtbaar maken',
	'centralauth-admin-unhide-description'            => 'Door de gebruiker opnieuw weer te geven wordt die weer zichtbaar in de lijst met [[Special:GlobalUsers|Globale gebruikers]].',
	'centralauth-admin-unhide-button'                 => 'Deze gebruiker zichtbaar maken',
	'centralauth-admin-unhide-success'                => 'De globale gebruiker "<nowiki>$1</nowiki>" is weer zichtbaar',
	'centralauth-admin-unhide-nonexistent'            => 'Fout: de globale gebruiker "<nowiki>$1</nowiki>" bestaat niet.',
	'centralauth-admin-markasmigrating-title'         => 'Gebruiker als in migratie markeren',
	'centralauth-admin-markasmigrating-description'   => 'Als de gebruiker in migratie is, kunnen lokale bureaucraten andere gebruikers naar deze naam hernoemen.',
	'centralauth-admin-markasmigrating-button'        => 'Gebruiker als in migratie markeren',
	'centralauth-admin-markasmigrating-success'       => 'De globale gebruiker "<nowiki>$1</nowiki>" is in migratie gemarkeerd',
	'centralauth-admin-markasmigrating-nonexistent'   => 'Fout: de globale gebruiker "<nowiki>$1</nowiki>" bestaat niet.',
	'centralauth-admin-unmarkasmigrating-title'       => 'Deze gebruiker niet langer als in migratie aanmerken',
	'centralauth-admin-unmarkasmigrating-description' => 'Maakt het mogelijk om de markering in migratie van een gebruiker te verwijderen',
	'centralauth-admin-unmarkasmigrating-button'      => 'Deze gebruiker niet langer als in migratie aanmerken',
	'centralauth-admin-unmarkasmigrating-success'     => 'De globale gebruiker "<nowiki>$1</nowiki>" is niet langer gemarkeerd als in migratie',
	'centralauth-admin-unmarkasmigrating-nonexistent' => 'Fout: de globale gebruiker "<nowiki>$1</nowiki>" bestaat niet.',
...
U hebt deze pagina opgevraagd zonder enige authenticatiegegevens op te geven en daarom gebeurt er niets.',
	'centralauth-login-progress'                      => 'U wordt aangemeld bij andere projecten van Wikimedia:',
	'centralauth-logout-progress'                     => 'U wordt afgemeld bij andere projecten van Wikimedia:',
	...
	'centralauth-log-entry-hide'                      => 'heeft de globale gebruiker "<nowiki>$1</nowiki>" verborgen',
	'centralauth-log-entry-unhide'                    => 'heeft de globale gebruiker "<nowiki>$1</nowiki>" zichtbaar gemaakt',
	'centralauth-log-entry-markasmigrating'           => 'heeft de globale gebruiker "<nowiki>$1</nowiki>" als in migratie gemarkeerd',
	'centralauth-log-entry-unmarkasmigrating'         => 'heeft de markering in migratie voor de globale gebruiker "<nowiki>$1</nowiki>" verwijderd',
...
Du kan endre hvilken wiki som regnes som din hjemmewiki senere.',
	...
	'centralauth-admin-hide-title'                    => 'Skjul konto',
	'centralauth-admin-hide-description'              => 'Skjulte kontoer vises ikke på [[Special:GlobalUsers|listen over globale brukere]].',
	'centralauth-admin-hide-button'                   => 'Skjul denne kontoen',
	'centralauth-admin-hide-success'                  => 'Den globale kontoen for «<nowiki>$1</nowiki>» ble skjult',
	'centralauth-admin-hide-nonexistent'              => 'Feil: Den globale kontoen «<nowiki>$1</nowiki>» finnes ikke.',
	'centralauth-admin-unhide-title'                  => 'Synliggjør konto',
	'centralauth-admin-unhide-description'            => 'Synliggjøring av kontoer vil gjøre at den dukker opp i listen over [[Special:GlobalUsers|globale brukere]] igjen.',
	'centralauth-admin-unhide-button'                 => 'Synliggjør denne kontoen',
	'centralauth-admin-unhide-success'                => 'Synliggjorde den globale kontoen for «<nowiki>$1</nowiki>»',
	'centralauth-admin-unhide-nonexistent'            => 'Feil: Den globale kontoen «<nowiki>$1</nowiki>» finnes ikke.',
	...
	'centralauth-autologin-desc'                      => 'Denne spesialsiden brukes internt av MediaWiki. Når du [[Special:Userlogin|logger inn]] instruerer det sentrale innloggingssystemet nettleseren din til å hente denne siden fra alle domener, ved hjelp av bildelenker.
Du har kommet til denne siden uten noen form for verifiseringsdata, så siden gjør ingenting.',
	'centralauth-login-progress'                      => 'Du er også logget inn på Wikimedias øvrige prosjekter:',
	'centralauth-logout-progress'                     => 'Du er også logget ut av Wikimedias øvrige prosjekter:',
	...
	'centralauth-log-entry-hide'                      => 'skjulte den globale kontoen «<nowiki>$1</nowiki>»',
...
Poiretz modificar vòstre projècte principal mai tard.',
	...
	'centralauth-admin-hide-title'                    => 'Amagar lo compte',
	'centralauth-admin-hide-description'              => 'Los comptes amagats son pas afichats demest [[Special:GlobalUsers|los utilizaires globals]].',
	'centralauth-admin-hide-button'                   => 'Amagar aqueste compte',
	'centralauth-admin-hide-success'                  => 'Lo compte global per « <nowiki>$1</nowiki> » es estat amagat amb succès.',
	'centralauth-admin-hide-nonexistent'              => 'Error : lo compte global « <nowiki>$1</nowiki> » existís pas.',
	'centralauth-admin-unhide-title'                  => 'Far tornar aparéisser lo compte',
	'centralauth-admin-unhide-description'            => 'La reaparicion del compte lo farà figurar demest los [[Special:GlobalUsers|utilizaires globals]].',
	'centralauth-admin-unhide-button'                 => 'Far tornar aparéisser aqueste compte',
	'centralauth-admin-unhide-success'                => 'Reaparicion del compte global « <nowiki>$1</nowiki> » realizada amb succès',
	'centralauth-admin-unhide-nonexistent'            => 'Error : lo compte global « <nowiki>$1</nowiki> » existís pas.',
	'centralauth-admin-markasmigrating-title'         => 'Marcar lo compte coma essent en migracion',
	'centralauth-admin-markasmigrating-description'   => "Se un compte es en migracion, los burocratas locals pòdon tornar nomenar d'autres comptes vèrs son nom.",
	'centralauth-admin-markasmigrating-button'        => 'Marcar aqueste compte coma essent en migracion',
	'centralauth-admin-markasmigrating-success'       => 'Lo compte global « <nowiki>$1</nowiki> » es estat marcat en migracion amb succès',
	'centralauth-admin-markasmigrating-nonexistent'   => 'Error : lo compte global « <nowiki>$1</nowiki> » existís pas.',
...
Avètz demandat aquesta pagina sens balhar d'entresenhas d'autentificacion, doncas reagís pas.",
	'centralauth-login-progress'                      => 'Connexion als autres projèctes Wikimèdia :',
	'centralauth-logout-progress'                     => 'Desconnexion dels autres projèctes Wikimèdia :',
	...
	'centralauth-log-entry-hide'                      => 'a amagat lo compte global « <nowiki>$1</nowiki> »',
	'centralauth-log-entry-unhide'                    => 'a fach tornar aparéisser lo compte global « nowiki>$1</nowiki> »',
...
Jeżeli konto uniwersalne należy również do Ciebie i chcesz przyłączyć do niego to konto, podaj hasło uniwersalnego konta:',
	...
	'centralauth-admin-hide-title'                    => 'Ukrywanie konta',
	'centralauth-admin-hide-description'              => 'Ukryte konta nie będą prezentowane w [[Special:GlobalUsers|spisie kont uniwersalnych]].',
	'centralauth-admin-hide-button'                   => 'Ukryj to konto',
	'centralauth-admin-hide-success'                  => 'Ukryto konto uniwersalne „<nowiki>$1</nowiki>”',
	'centralauth-admin-hide-nonexistent'              => 'Błąd: nie istnieje konto uniwersalne „<nowiki>$1</nowiki>”.',
	'centralauth-admin-unhide-title'                  => 'Zakończ ukrywanie konta',
	'centralauth-admin-unhide-description'            => 'Zakończenie ukrywania konta spowoduje jego widoczność na stronie [[Special:GlobalUsers|spisu kont uniwersalnych]].',
	'centralauth-admin-unhide-button'                 => 'Zakończ ukrywanie konta',
	'centralauth-admin-unhide-success'                => 'Zakończono ukrywanie konta uniwersalnego „<nowiki>$1</nowiki>”',
	'centralauth-admin-unhide-nonexistent'            => 'Błąd: nie istnieje konto uniwersalne „<nowiki>$1</nowiki>”.',
	'centralauth-admin-markasmigrating-title'         => 'Oznacz konto jako podlegające migracji',
	'centralauth-admin-markasmigrating-description'   => 'Lokalni biurokraci mogą zmienić nazwę dowolnego konta na nazwę konta, które jest w stanie migracji.',
	'centralauth-admin-markasmigrating-button'        => 'Oznacz konto jako podlegające migracji',
	'centralauth-admin-markasmigrating-success'       => 'Dla konta uniwersalnego oznaczono „<nowiki>$1</nowiki>” jako podlegające migracji',
	'centralauth-admin-markasmigrating-nonexistent'   => 'Błąd: konto uniwersalne „<nowiki>$1</nowiki>” nie istnieje.',
	'centralauth-admin-unmarkasmigrating-title'       => 'Usuń zaznaczenie konta, jako podlegającego migracji',
	'centralauth-admin-unmarkasmigrating-description' => 'Pozwala na usunięcie dla konta znacznika migracji.',
	'centralauth-admin-unmarkasmigrating-button'      => 'Usuń zaznaczenie konta jako podlegającego migracji',
	'centralauth-admin-unmarkasmigrating-success'     => 'Dla konta uniwersalnego usunięto oznaczenie „<nowiki>$1</nowiki>” jako podlegającego migracji',
	'centralauth-admin-unmarkasmigrating-nonexistent' => 'Błąd: konto uniwersalne „<nowiki>$1</nowiki>” nie istnieje.',
...
Zażądałeś tej strony bez podania informacji o uwierzytelnieniu, stąd brak obsługi.',
	...
	'centralauth-log-entry-hide'                      => 'ukrył konto uniwersalne „<nowiki>$1</nowiki>”',
	'centralauth-log-entry-unhide'                    => 'zakończył ukrywanie konta uniwersalnego „<nowiki>$1</nowiki>”',
	'centralauth-log-entry-markasmigrating'           => 'oznaczył konto uniwersalne „<nowiki>$1</nowiki>”, jako podlegające migracji',
	'centralauth-log-entry-unmarkasmigrating'         => 'usunął oznaczenie konta uniwersalnego „<nowiki>$1</nowiki>”, jako podlegającego migracji',
...
$messages['qu'] = array(
	...
	'centralauth-admin-unmerge-success'    => '$1 {{PLURAL:$1|rakiquna|rakiqunakuna}} aypalla rakisqañam.',
	...
	'centralauth-admin-lock-title'         => "Rakiqunata hark'ay",
	'centralauth-admin-lock-description'   => "Kay rakiquna hark'asqa kaptinqa, manam saqillanqachu paywan ima wikimanpas yaykuyta.",
	'centralauth-admin-lock-button'        => "Kay rakiqunata hark'ay",
	'centralauth-admin-lock-success'       => '"<nowiki>$1</nowiki>" nisqapaq sapsi rakiqunaqa aypalla hark\'asqañam',
	'centralauth-admin-lock-nonexistent'   => 'Pantasqa: "<nowiki>$1</nowiki>" nisqapaq sapsi rakiqunaqa manam kanchu.',
	'centralauth-admin-unlock-title'       => 'Rakiqunata paskay',
	'centralauth-admin-unlock-button'      => 'Kay rakiqunata paskay',
	'centralauth-admin-unlock-success'     => '"<nowiki>$1</nowiki>" nisqapaq sapsi rakiqunaqa aypalla paskasqañam',
	'centralauth-admin-unlock-nonexistent' => 'Pantasqa: "<nowiki>$1</nowiki>" nisqapaq sapsi rakiqunaqa manam kanchu.',
	'centralauth-admin-reason'             => 'Kayrayku:',
	'globalusers'                          => 'Sapsi ruraqniyuq sutisuyu',
	'centralauth-listusers-locked'         => "hark'asqa",
	'centralauth-listusers-attached'       => "k'itillapi kan",
...
Другие учётные записи пока ещё не подтверждены.',
	...
	'centralauth-admin-hide-title'                    => 'Скрыть учётную запись',
	'centralauth-admin-hide-description'              => 'Скрытые учётные записи не показываются в [[Special:GlobalUsers|списке глобальных участников]].',
	'centralauth-admin-hide-button'                   => 'Скрыть эту учётную запись',
	'centralauth-admin-hide-success'                  => 'Успешно скрыта глобальная учётная запись «<nowiki>$1</nowiki>»',
	'centralauth-admin-hide-nonexistent'              => 'Ошибка. Глобальной учётной записи «<nowiki>$1</nowiki>» не существует.',
	'centralauth-admin-unhide-title'                  => 'Раскрыть учётную запись',
	'centralauth-admin-unhide-description'            => 'Раскрытие учётной записи сделает её видимой в [[Special:GlobalUsers|списке глобальных участников]].',
	'centralauth-admin-unhide-button'                 => 'Раскрыть эту учётную запись',
	'centralauth-admin-unhide-success'                => 'Успешно раскрыта глобальная учётная запись «<nowiki>$1</nowiki>»',
	'centralauth-admin-unhide-nonexistent'            => 'Ошибка. Глобальной учётной записи «<nowiki>$1</nowiki>» не существует.',
	'centralauth-admin-markasmigrating-title'         => 'Отметить учётную запись как мигрирующую',
	'centralauth-admin-markasmigrating-description'   => 'Если учётная запись отмечена как мигрирующая, локальные бюрократы могут переименовывать другие учётные записи в это имя.',
	'centralauth-admin-markasmigrating-button'        => 'Отметить учётную запись как мигрирующую',
	'centralauth-admin-markasmigrating-success'       => 'Глобальная учётная запись для «<nowiki>$1</nowiki>» успешно отмечена как мигрирующая',
	'centralauth-admin-markasmigrating-nonexistent'   => 'Ошибка. Глобальной учётной записи «<nowiki>$1</nowiki>» не существует.',
	'centralauth-admin-unmarkasmigrating-title'       => 'Снять отметку мигрирования с этой учётной записи',
	'centralauth-admin-unmarkasmigrating-description' => 'Разрешить удалять отметку о миграции с этой учётной записи.',
	'centralauth-admin-unmarkasmigrating-button'      => 'Снять отметку о мигрировании',
	'centralauth-admin-unmarkasmigrating-success'     => 'С глобальной учётной записи для «$1» успешно снята отметка о мигрировании',
	'centralauth-admin-unmarkasmigrating-nonexistent' => 'Ошибка. Глобальной учётной записи »<nowiki>$1</nowiki> не существует.',
	'centralauth-admin-reason'                        => 'Причина:',
...
Вы запросили эту страницу без предоставления информации об аутентификации, поэтому ничего не происходит.',
	'centralauth-login-progress'                      => 'Сеанс действует также и в других проектах Викимедиа:',
	'centralauth-logout-progress'                     => 'Сеанс завершён также и в других проектах Викимедиа:',
	...
	'centralauth-log-entry-hide'                      => 'скрыл глобальную учётную запись «<nowiki>$1</nowiki>»',
	'centralauth-log-entry-unhide'                    => 'раскрыл глобальную учётную запись «<nowiki>$1</nowiki>»',
	'centralauth-log-entry-markasmigrating'           => 'отметил глобальную учётную запись «<nowiki>$1</nowiki>» как мигрирующую',
	'centralauth-log-entry-unmarkasmigrating'         => 'снял отметку о мигрировании с глобальной учётной записи «<nowiki>$1</nowiki>»',
...
Nie je ''povinné'' spojiť všetky účty; niektoré môžete nechať oddelené, a budú tak označené.",
	...
	'centralauth-merge-step1-detail'                  => 'Prosím, zadajte heslo k vášmu účtu.
Vaše heslo a registrovaná emailová adresa bude porovnaná s účtami na ostatných wiki, aby sa potvrdilo, že sa zhodujú.
Žiadne zmeny sa nevykonajú, kým nepotvrdíte, že je to v poriadku.',
...
Svoju domovskú wiki budete môcť zmeniť neskôr.',
	...
	'centralauth-admin-hide-title'                    => 'Skryť účet',
	'centralauth-admin-hide-description'              => 'Skryté účty sa nezobrazujú na stránke [[Special:GlobalUsers|Globálni používatelia]].',
	'centralauth-admin-hide-button'                   => 'Skryť tento účet',
	'centralauth-admin-hide-success'                  => 'Globálny účet „<nowiki>$1</nowiki>” bol úspešne skrytý.',
	'centralauth-admin-hide-nonexistent'              => 'Chyba: globálny účet „<nowiki>$1</nowiki>” neexistuje.',
	'centralauth-admin-unhide-title'                  => 'Zrušiť skrytie účtu',
	'centralauth-admin-unhide-description'            => 'Po zrušení skrytia sa účet znova objaví na stránke [[Special:GlobalUsers|Globálni používatelia]].',
...
Keď sa [[Special:UserLogin|prihlásite]], centrálny systém prihlasovania dá vedieť vášmu prehliadaču, aby vyžiadal túto stránku zo všetkých domén, na ktoré sa odkazuje, za pomoci odkazov na obrázky.
Keďže ste túto stránku vyžiadali bez poskytnutia overovacích údajov, nerobí nič.',
	'centralauth-login-progress'                      => 'Prihlasujete sa na iné projekty Wikimedia:',
	'centralauth-logout-progress'                     => 'Odhlasujete sa z iných projektov Wikimedia:',
...
Wan uurswäl din Benutsernoome al in n uur Projekt benutset, so be-ienfloudet et dissen nit, man du hääst ju Muugelkhaid, leeter mäd dissen uur Benutser of in Touhoopeoarbaid mäd n Administrator ätter ne Löösenge tou säiken.",
	...
	'centralauth-merge-step1-detail'                  => 'Reek dien Paaswoud ien. Dät wäd touhoope mäd dien iendraine E-Mail-Adresse mäd Benutserkonten in do uur Wikis ouglieked, uum Uureenstämmengen tou fienden. Der wäide neen Annerengen foarnuumen, bit du bestäätigest, dät aal gjucht is.',
...
Do Paaswoude foar do lokoale Benutserkonten wäide ap dät uursproangelke Paaswoud foar ju Touhoopefierenge touräächsät.',
	...
	'centralauth-listusers-nolocal'                   => 'nit ferbuunen of lokoal nit foarhounden',
...
Du hääst disse Spesioalsiede sunner Authentizierengsdoaten apruupen, so dät niks Wiederes geböärt.',
	...
	'centralauth-rightslog-name'                      => 'Globoal Gjuchte-Logbouk',
	'centralauth-rightslog-entry-usergroups'          => 'annerde ju globoale Gruppentouheeregaid foar „$1“ fon $2 ap $3',
	'centralauth-rightslog-entry-groupperms'          => 'annerde do Gruppengjuchte foar „$1“ fon $2 ap $3',
	'centralauth-rightslog-header'                    => 'Dit Logbouk änthaalt Annerengen an globoale Gruppen: Meeglidskup un Gjuchteannerengen.',
	'globalgroupmembership'                           => 'Meeglidskup in globoale Gruppen',
	'globalgrouppermissions'                          => 'Management fon globoale Gruppen',
	'centralauth-globalgroupperms-grouplist'          => 'Do foulgjende globoale Gruppen wuuden konfigurierd. Du koast do älke Gruppe touwiesde Gjuchte sjo un annerje. Ne Gruppe kon läsked wäide, as aal Gjuchte wächhoald wäide.',
	'centralauth-globalgroupperms-grouplistitem'      => '$1 ([[Special:GlobalGroupPermissions/$2|Gjuchte ankiekje un beoarbaidje]])',
	'centralauth-existinggroup-legend'                => 'Bestoundende Gruppen',
	'centralauth-newgroup-legend'                     => 'Näie Gruppe moakje',
	'centralauth-newgroup-intro'                      => 'Du koast mäd dit Formular ne näie Gruppe Gjuchte tou-oardenje. Beoachtje, dät ju Gruppe soloange nit foarhounden is, bit hiere Gjuchte touwiesd wäide.',
	'centralauth-globalgroupperms-newgroupname'       => 'Näie Gruppennoome:',
	'centralauth-globalgroupperms-creategroup-submit' => 'Gjuchte touwiese',
	'centralauth-editgroup-subtitle'                  => 'Beoarbaidje $1',
	'centralauth-editgroup-fieldset'                  => 'Gjuchte foar $1',
	'centralauth-editgroup-name'                      => 'Noome fon ju Gruppe:',
...
Kecap sandi sarta alamat Surélék kadaptar baris dicocogkeun di antara rekening-rekening di wiki séjén pikeun mastikeun yén rekening-rekening dipiboga pamaké anu sarua.
Parobahan moal dipigawé nepi ka Anjeun mikeun konfirmasi yén teu aya masalah.',
...
Engké, anjeun bakal bisa milih wiki asal anjeun.',
	...
	'centralauth-admin-already-unmerged'   => '$1 diliwat, alatan geus batal digabungkeun',
	'centralauth-admin-unmerge-success'    => 'Junun batal ngagabungkeun $1 rekening',
	'centralauth-admin-delete-title'       => 'Ngahapus rekening',
	'centralauth-admin-delete-description' => 'Ngahapus rekening global baris turut ngahapus préferénsi global, ngabolaykeun panggabungan kabéh rekening lokal, sarta ku kituna ngaran global kasebut bisa dipaké ku pamaké séjénna.
Sakumna rekening lokal baris tetep aya.
Kecap sandi pikeun rekening-rekening lokal sacara otomatis balik ka kecap sandi saméméh panggabungan.',
	...
	'centralauth-admin-lock-title'         => 'Konci rekening',
	...
	'centralauth-editgroup-subtitle'       => 'Ngédit $1',
...
Om någon annan redan har tagit ditt användarnamn på ett annat projekt så påverkar det här inte denne nu, men du kommer att få möjlighet att reda ut det med personen i fråga eller med en administratör senare.",
	...
	'centralauth-merge-step1-detail'                  => 'Var god skriv in kontonamnet och ditt lösenord här.
Ditt lösenord och din e-postadress kommer kontrolleras mot användarkonton på andra wikier för att bekräfta att de stämmer överens. Inga ändringar kommer att genomföras innan du bekräftar att allting ser riktigt ut.',
...
Du kommer senare kunna ändra vilken wiki som är din hemwiki.',
	...
	'centralauth-admin-hide-title'                    => 'Dölj konto',
	'centralauth-admin-hide-description'              => 'Dolda konton visas inte på [[Special:GlobalUsers|listan över globala användare]].',
	'centralauth-admin-hide-button'                   => 'Dölj det här kontot',
	'centralauth-admin-hide-success'                  => 'Det globala kontot för "<nowiki>$1</nowiki>" doldes',
	'centralauth-admin-hide-nonexistent'              => 'Fel: det globala kontot "<nowiki>$1</nowiki>" existerar inte.',
	'centralauth-admin-unhide-title'                  => 'Synliggör konto',
	'centralauth-admin-unhide-description'            => 'Synliggöring av konton kommer göra att det dyker upp igen i listan över [[Special:GlobalUsers|globala användare]].',
	'centralauth-admin-unhide-button'                 => 'Synliggör det här kontot',
	'centralauth-admin-unhide-success'                => 'Synliggjorde det globala kontot för "<nowiki>$1</nowiki>"',
...
Du har begärt den här sidan utan att ha angivit någon verifieringsdata, så den gör ingenting.',
	'centralauth-login-progress'                      => 'Loggar in dig till Wikimedias övriga projekt:',
	'centralauth-logout-progress'                     => 'Loggar ut dig från Wikimedias övriga projekt:',
...
మిగతా ఖాతాలు ఇంకా నిర్ధారణ కాలేదు.',
	...
	'centralauth-admin-hide-button'                   => 'ఈ ఖాతాని దాచు',
...
$messages['th'] = array(
	...
	'centralauth-admin-lock-title'         => 'ล็อกบัญชีผู้ใช้นี้',
	'centralauth-admin-lock-button'        => 'ล็อกบัญชีผู้ใช้นี้',
...
Однак, для цього облікового запису виявлено інший вікі-проект, який визначений як «домашній»; щоб завершити процедуру міграції, перейдіть по наведеному нижче посиланню і ввійдіть до системи.',
	...
	'centralauth-complete-text'                       => "Тепер ви можете авторизуватися на будь-якому сайті Вікімедіа без створення нового облікового запису. Одні й ті самі ім'я користувача і пароль будуть працювати у Вікіпедії, Вікісловнику, Вікіпідручнику та інших проектах на всіх мовах.",
...
Ви запитали цю сторінку без надання інформації про автентифікацію, тому нічого не відбувається.',
	'centralauth-login-progress'                      => 'Вхід у систему також в інших проектах Вікімедіа:',
	...
	'centralauth-globalgrouppermissions-knownwiki'    => 'Оберіть вікі, в якій вони мають облікові записи:',
...
Se te sì ti el paron de l\'utenza, par finir el processo de unificazion basta che te inserissi la password prinçipal de quel\'account qua de seguito:',
	'centralauth-blocked-text'                        => 'La to wiki prinçipal (mostrà qua soto) la xe blocà e no se pol modificarla. Par piaser contatta un aministrador par desblocarla. Finché la xe blocà, no ti podi unificar i to account.',
	'centralauth-notice-dryrun'                       => "<div class='successbox'>Solo modalità Demo</div><br clear='all'/>",
...
Le password par i account locali creà prima de l'unificazion le tornarà indrio a i so valori precedenti l'unificazion.",
	...
	'centralauth-admin-hide-title'                    => 'Scondi account',
	'centralauth-admin-hide-description'              => 'I account sconti no i xe mostrà tra i [[Special:GlobalUsers|utenti globali]].',
	'centralauth-admin-hide-button'                   => 'Scondi sto account',
	'centralauth-admin-hide-success'                  => 'L\'account globale par "<nowiki>$1</nowiki>" el xe stà sconto',
	'centralauth-admin-hide-nonexistent'              => 'Eror: l\'account globale "<nowiki>$1</nowiki>" no l\'esiste mìa.',
	'centralauth-admin-unhide-title'                  => "Mostra de novo l'account",
	'centralauth-admin-unhide-description'            => "Mostrando de novo l'account el vegnarà fora de novo anca sui [[Special:GlobalUsers|utenti globali]].",
	'centralauth-admin-unhide-button'                 => 'Mostra de novo sto account',
	'centralauth-admin-unhide-success'                => 'L\'account globale par "<nowiki>$1</nowiki>" el xe mostrà de novo',
...
Te ghè domandà sta pagina sensa fornir nissun dato de autenticassion, quindi no la pol far gnente.',
	...
	'centralauth-log-entry-hide'                      => 'gà sconto l\'account globale "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-unhide'                    => 'gà mostrà de novo l\'account globale "<nowiki>$1</nowiki>"',
...
Mật khẩu của các tài khoản địa phương đã có trước khi hợp nhất sẽ quay về giá trị như ban đầu.',
	...
	'centralauth-admin-hide-title'                    => 'Ẩn tài khoản',
	'centralauth-admin-hide-description'              => 'Tài khoản bị ẩn không hiển thị trên [[Special:GlobalUsers]].',
	'centralauth-admin-hide-button'                   => 'Ẩn tài khoản này',
	'centralauth-admin-hide-success'                  => 'Đã ẩn thành công tài khoản thống nhất "<nowiki>$1</nowiki>"',
	'centralauth-admin-hide-nonexistent'              => 'Lỗi: tài khoản thống nhất "<nowiki>$1</nowiki>" không tồn tại.',
	'centralauth-admin-unhide-title'                  => 'Hiện tài khoản',
	'centralauth-admin-unhide-description'            => 'Hiện tài khoản sẽ khiến nó xuất hiện trở lại trong [[Special:GlobalUsers]].',
	'centralauth-admin-unhide-button'                 => 'Hiện tài khoản này',
	'centralauth-admin-unhide-success'                => 'Đã hiện thành công tài khoản thống nhất "<nowiki>$1</nowiki>"',
...
Bạn đã yêu cầu trang này mà không cung cấp bất kỳ dữ liệu xác nhận nào cả, do đó nó không làm gì hết.',
	...
	'centralauth-log-entry-hide'                      => 'đã ẩn tài khoản thống nhất "<nowiki>$1</nowiki>"',
	'centralauth-log-entry-unhide'                    => 'đã hiện tài khoản thống nhất "<nowiki>$1</nowiki>"',
