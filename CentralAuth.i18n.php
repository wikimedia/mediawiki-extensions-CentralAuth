...
$wgCentralAuthMessages['it'] = array(
	...
	'centralauth-merge-step2-detail'       => 'Alcuni degli account non possono essere connessi automaticamente a quello sulla tua wiki principale. Se questi account ti appartengono, conferma che sono i tuoi indicando le password per ciascuno di loro.',
	'centralauth-merge-step2-submit'       => 'Conferma le informazioni di login',
	'centralauth-merge-step3-title'        => 'Crea l\'account unificato',
	'centralauth-merge-step3-detail'       => 'E\' tutto pronto per creare il tuo account unificato sulle seguenti wiki:',
...
Se si è il titolare dell\'utenza, per terminare il processo di unificazione è sufficiente inserire la password principale di quell\'account qui di seguito:',
	...
	'centralauth-attach-text'              => 'Questo account non è ancora stato collegato all\'account unificato. Se anche l\'account globale è tuo, puoi collegare questo account digitando la password dell\'account globale:',
