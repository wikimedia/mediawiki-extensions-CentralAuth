...
Se la ĝenerala konto ankaŭ estas via, vi povas unuigi ĉi tiun konton se vi tajpas la pasvorton de la ĝenerala konto:',
	...
	'centralauth-log-name'                 => 'Loglibro pri kontrolado de ĝeneralaj kontoj',
	'centralauth-log-header'               => 'Ĉi tiu loglibro enhavas operaciojn sub ĝeneralaj kontoj: forigojn, ŝlosadon, kaj malŝlosadon.',
...
Un autre wiki es estat determinat coma compte principal per vòstre nom d’utilizaire ; seguissètz lo ligam çaijós e connectatz-vos per acabar la migracion del compte.',
	...
	'centralauth-incomplete'               => 'Unificacion del compte incomplèta !',
...
$messages['pl'] = array(
	...
	'centralauth-mergeaccount-desc'        => '[[Special:MergeAccount|Łączy różne konta]] w jedno konto globalne',
...
Jeśli ktoś inny wykorzystuje na innym projekcie identyczną nazwę użytkownika do Twojej, przekształcenie Twojego konta na globalne nie stanie się dla niego problemem, lecz da Ci szansę na późniejsze znalezienie rozwiązania we współpracy bezpośrednio z tą osobą lub z wykorzystaniem pomocy któregoś z administratorów.",
	...
	'centralauth-merge-step2-detail'       => 'Niektóre z kont nie mogły zostać automatycznie przyłączone do konta globalnego.
...
Nie wykonano jeszcze żadnych zmian Twoich kont.',
	...
	'centralauth-merge-dryrun-home'        => 'System migracji nie może potwierdzić, że na wiki macierzystej jesteś właścicielem konta o Twojej nazwie użytkownika.
...
Inna wiki została uznana za macierzystą. Kliknij w link poniżej i zaloguj się do niej, aby ukończyć migrację konta.',
	...
	'centralauth-incomplete'               => 'Tworzenie konta globalnego nie zostało ukończone!',
...
Ta sama nazwa użytkownika i hasło będą działać na Wikipedii, Wikisłowniku, Wikicytatach i innych projektach siostrzanych we wszystkich językach.',
	'centralauth-incomplete-text'          => 'Kiedy Twoje konto stanie są kontem globalnym, będziesz mógł zalogować się do każdej wiki Wikimedia bez potrzeby zakładania nowego konta. Ta sama nazwa użytkownika i hasło będą funkcjonować na Wikipedii, Wikisłowniku, Wikibooks oraz pozostałych projektach siostrzanych, we wszystkich językach.',
...
Jeśli chcesz przyłączyć konto użytkownika „$1” do konta globalnego podaj hasło konta na $2:',
	...
	'centralauth-disabled-dryrun'          => 'Tworzenie konta globalnego jest dostępne tylko w trybie demonstracyjnym / usuwania usterek. Właściwe operacje łączenia kont są obecnie wyłączone.',
...
W przyszłości będziesz jednak mógł zmienić swoją macierzystą wiki.',
	...
	'centralauth-list-unattached'          => 'Dla witryn wymienionych poniżej konto o nazwie „$1” nie może zostać automatycznie przyłączone do konta globalnego. Najbardziej prawdopodobną przyczyną problemów jest ustawienie dla tych witryn innego hasła niż dla konta macierzystego.',
	'centralauth-foreign-link'             => 'Użytkownik $1 na $2',
	'centralauth-merge-method-primary'     => 'wiki macierzysta',
...
Pozostałe nie zostały jeszcze potwierdzone.',
	'centralauth-merge-attempt'            => "'''Sprawdzanie hasła dla pozostałych kont, nieprzyłączonych do konta globalnego...'''",
	'centralauth-attach-list-attached'     => 'Konto globalne „$1” obejmuje następujące konta:',
	'centralauth-attach-title'             => 'Potwierdź konto',
	'centralauth-attach-text'              => 'To konto nie zostało jeszcze przyłączone do konta globalnego.
Jeżeli konto globalne należy również do Ciebie i chcesz przyłączyć do niego to konto, podaj hasło konta globalnego:',
	...
	'centralauth-admin-delete-success'     => 'Usunięto konto globalne „<nowiki>$1</nowiki>”',
	...
	'globalusers'                          => 'Spis kont globalnych',
	...
	'centralauth-renameuser-abort'         => '<div class="errorbox">Nie można lokalnie zmienić nazwy użytkownika „$1”, ponieważ to konto jest przyłączone do konta globalnego.</div>',
	'centralauth-renameuser-exists'        => '<div class="errorbox">Nie można zmienić nazwy użytkownika „$2”, ponieważ nowa nazwa jest zarezerwowana dla konta globalnego.</div>',
	'centralauth-invalid-wiki'             => 'Nie istnieje wiki DB: $1',
	'centralauth-account-exists'           => 'Utworzenie konta nie jest możliwe – wybrana nazwa użytkownika jest zajęta przez konto globalne.',
