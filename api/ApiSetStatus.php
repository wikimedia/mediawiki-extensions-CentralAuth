 ...
 * @ingroup Extensions
 */
class ApiSetStatus extends ApiBase {
	...
	public function getParamDescription() {
		return array(
			...
			'hidden' => "Change whether this user is hidden or not. Possible values are '', 'lists', or 'suppressed'",
	...
	public function getExamples() {
		return array(
			'api.php?action=setstatus&user=Spammer&locked=true&hidden=&reason=Spam',
			'api.php?action=setstatus&user=Jimbo_Wales&locked=true&hidden=suppressed&reason=I can',
		);
	}
