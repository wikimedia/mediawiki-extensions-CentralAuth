...
$specialPageAliases['bn'] = [
	...
	'MultiLock' => [ 'বহু_তালাবদ্ধকরণ', 'বহুতালা' ],
	'GlobalRenameUser' => [ 'বৈশ্বিক_ব্যবহারকারী_নামান্তর', 'বৈশ্বিক_ব্যবহারকারী_পুনঃনামকরণ', 'বৈশ্বিক_ব্যবহারকারী_নাম_পরিবর্তন' ],
	'GlobalRenameProgress' => [ 'বৈশ্বিক_নামান্তরের_অগ্রগতি' ],
	'GlobalRenameRequest' => [ 'বৈশ্বিক_নামান্তরের_অনুরোধ', 'বৈশ্বিক_নাম_পরিবর্তনের_অনুরোধ' ],
	'GlobalRenameQueue' => [ 'বৈশ্বিক_নামান্তরের_সারি' ],
	'GlobalVanishRequest' => [ 'বৈশ্বিকভাবে_ভ্যানিশ_হওয়ার_অনুরোধ', 'ভ্যানিশ_হওয়ার_অনুরোধ' ],
];
...
$specialPageAliases['uk'] = [
	'CentralAuth' => [ 'Інформація_про_глобальний_обліковий_запис' ],
	'CreateLocalAccount' => [ 'Створити_локальний_обліковий_запис' ],
	...
	'GlobalRenameProgress' => [ 'Прогрес_глобального_перейменування' ],
	'GlobalRenameRequest' => [ 'Глобальний_запит_на_перейменування' ],
	'GlobalVanishRequest' => [ 'Глобальний_запит_на_затирання' ],
];
