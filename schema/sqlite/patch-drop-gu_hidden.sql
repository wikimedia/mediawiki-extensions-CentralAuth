...
-- Source: schema/abstractSchemaChanges/patch-drop-gu_hidden.json
...
INSERT INTO /*_*/globaluser (
  ...
  gu_password, gu_locked, gu_hidden_level,
  gu_registration, gu_password_reset_key,
  gu_password_reset_expiration, gu_auth_token,
  gu_cas_token
)
SELECT
  gu_id,
