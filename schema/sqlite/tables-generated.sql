...
CREATE TABLE /*_*/globaluser (
  ...
  gu_name BLOB DEFAULT NULL, gu_enabled BLOB DEFAULT '' NOT NULL,
  gu_enabled_method TEXT DEFAULT NULL,
  gu_home_db BLOB DEFAULT NULL, gu_email BLOB DEFAULT NULL,
  gu_email_authenticated BLOB DEFAULT NULL,
