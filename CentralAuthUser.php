...
class CentralAuthUser {
	...
	function getGlobalRights() {
		...
		if ($rights = $wgMemc->get( 'centralauth-userrights-'.$this->getId() )) {
		...
		// Save to the cache.
		$wgMemc->set( 'centralauth-userrights-'.$this->getId(), $rights );
	...
	function invalidateRightsCache() {
		global $wgMemc;
		$wgMemc->delete( 'centralauth-userrights-'.$this->getId() );
	}
}
