...
class CentralAuthUser extends AuthPluginUser {
	...
	/**
	 * Set locking and hiding settings for a Global User. This code was moved from
	 * SpecialCentralAuth.php so that other modules don't have to duplicate the logic.
