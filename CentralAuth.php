...
$wgAutoloadClasses['ApiLockGlobalUser'] = "$caBase/api/ApiLockGlobalUser.php";
...
$wgAPIModules['globallock'] = 'ApiLockGlobalUser';
...
$wgHooks['ApiTokensGetTokenTypes'][] = 'ApiLockGlobalUser::injectTokenFunction';
