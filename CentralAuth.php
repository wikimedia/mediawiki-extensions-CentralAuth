...
$wgAutoloadClasses['ApiCentralAuthToken'] = "$caBase/api/ApiCentralAuthToken.php";
...
$wgAutoloadClasses['GlobalUserMergeDatabaseUpdates'] = "$caBase/GlobalRename/GlobalUserMergeDatabaseUpdates.php";
$wgAutoloadClasses['UserMergeNoopLogger'] = "$caBase/GlobalRename/UserMergeNoopLogger.php";
