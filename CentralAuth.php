...
$wgHooks['HandleWikiSetLogEntry'][] = 'CentralAuthHooks::onHandleWikiSetLogEntry';
$wgHooks['HandleGrouprenameLogEntry'][] = 'CentralAuthHooks::onHandleGrouprenameLogEntry';
...
$wgLogActionsHandlers['gblrights/grouprename'] = 'HandleGrouprenameLogEntry';
...
foreach ( array( 'newset', 'setrename', 'setnewtype', 'setchange', 'deleteset' ) as $type ) {
	$wgLogActionsHandlers["gblrights/{$type}"] = 'HandleWikiSetLogEntry';
}
