...
$wgAutoloadClasses['includes/GlobalRenameLogFormatter'] = "$caBase/GlobalRename/GlobalRenameLogFormatter.php";
$wgAutoloadClasses['GlobalUserMergeLogFormatter'] = "$caBase/includes/GlobalRename/GlobalUserMergeLogFormatter.php";

$wgAutoloadClasses['includes/GlobalRenameUser'] = "$caBase/GlobalRename/GlobalRenameUser.php";
$wgAutoloadClasses['includes/GlobalRenameUserStatus'] = "$caBase/GlobalRename/GlobalRenameUserStatus.php";
$wgAutoloadClasses['includes/GlobalRenameUserValidator'] = "$caBase/GlobalRename/GlobalRenameUserValidator.php";
$wgAutoloadClasses['includes/GlobalRenameUserDatabaseUpdates'] = "$caBase/GlobalRename/GlobalRenameUserDatabaseUpdates.php";
$wgAutoloadClasses['includes/GlobalRenameUserLogger'] = "$caBase/GlobalRename/GlobalRenameUserLogger.php";
