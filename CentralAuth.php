...
if ( class_exists( MediaWiki\Auth\AuthManager::class ) && empty( $wgDisableAuthManager ) ) {
	// Prepend our primary authentication provider, just after
	// TemporaryPasswordPrimaryAuthenticationProvider
	$wgAuthManagerAutoConfig['primaryauth'] = wfArrayInsertAfter(
	...
	$wgAuthManagerAutoConfig['secondaryauth'] = array_merge(
		[
