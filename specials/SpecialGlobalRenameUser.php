...
class SpecialGlobalRenameUser extends FormSpecialPage {
	...
	function onSubmit( array $data ) {
		...
		// Canonicalize the new name, remove _'s, uppercase the first letter, etc.
		// Note that this will never return false since we already validated the username
		// in $this->validate()
		$this->newUsername = User::getCanonicalName( $data['newname'], 'creatable' );
