( function ( mw, $ ) {
	...
	function CentralAuthForeignApi( options ) {
		...
		if ( !options || !options.url ) {
			...
			// We're logged in here, check to see if we're logged in on the foreign wiki too, and thus can
			// skip 'centralauthtoken' requests
			CentralAuthForeignApi.parent.prototype.get.call( this, { action: 'query', meta: 'userinfo' } )
				.done( function ( resp ) {
