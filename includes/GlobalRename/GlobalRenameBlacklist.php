...
class GlobalRenameBlacklist {
	 ...
	 * Constructor
	 *
	 * @param string|Title|null $file Source of blacklist to use, or null to use $wgGlobalRenameBlacklist
	 */
	...
	private function fetchBlacklist() {
		...
		if ( $this->file instanceof Title ) {
			...
			// $content should be WikitextContent, butphan doesn't think so
