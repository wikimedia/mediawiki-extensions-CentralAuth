...
class CentralAuthUser extends AuthPluginUser {
	...
	protected function loadState( $recache = false ) {
		...
		$db = $fromMaster ? self::getCentralDB() : self::getCentralSlaveDB();
	...
	protected function loadGroups() {
		...
		$db = $this->shouldUseMasterDB() ? self::getCentralDB() : self::getCentralSlaveDB();
	...
	private function doListUnattached() {
		...
		$db = ( $this->shouldUseMasterDB() || self::centralLBHasRecentMasterChanges() )
			? self::getCentralDB()
