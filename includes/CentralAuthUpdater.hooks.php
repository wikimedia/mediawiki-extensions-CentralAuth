...
class CentralAuthUpdaterHooks {
	...
	public static function onLoadExtensionSchemaUpdates( DatabaseUpdater $updater ) {
		global $wgCentralAuthCluster;
		if ( $wgCentralAuthCluster ) {
		...
		if ( $updater->getDB()->getType() == 'mysql' || $updater->getDB()->getType() == 'sqlite' ) {
			...
			$updater->addExtensionIndex( 'globaluser', 'gu_locked', __DIR__ . "/../db_patches/patch-gu_hidden.sql" );
			$updater->addExtensionIndex( 'globaluser', 'gu_hidden', __DIR__ . "/../db_patches/patch-gu_hidden.sql" );
		}
	}
}
